...
function compileTypedocs(_options, context) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    projects = Object.keys(context.workspace.projects).filter(function (projectName) {
                        var _a;
                        if (context.workspace.projects[projectName].projectType !== 'library') {
                            return false;
                        }
                        // @ts-ignore
                        return !!((_a = context.workspace.projects[projectName]) === null || _a === void 0
                            ? void 0
                            : _a.targets['compile-typedocs']);
                    });
                ...
                case 1:
                    ...
                    return [
                        ...
                        (0, run_1.runExecutor)(
                            ...
                            __assign({ projectName: projectName }, context)
                        )
                    ];
                case 2:
                    _a.sent();
