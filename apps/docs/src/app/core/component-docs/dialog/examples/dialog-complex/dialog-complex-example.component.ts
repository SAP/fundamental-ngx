...
export class DialogComplexExampleComponent {
    ...
    fruitCollection: Fruit[] = [
        ...
        {id: 2, name: 'Passion Fruit', price: 10.00},
        {id: 3, name: 'Papaya', price: 8.99},
        {id: 4, name: 'Kiwifruit', price: 3.00},
        {id: 5, name: 'Mango', price: 15.00},
        {id: 6, name: 'Pomegranate', price: 12.50},
        {id: 7, name: 'Guava', price: 10.15},
        {id: 8, name: 'Durian', price: 15.25},
        {id: 9, name: 'Jackfruit', price: 10.00},
        {id: 10, name: 'Dragon Fruit', price: 9.00},
        {id: 11, name: 'Cherimoya', price: 7.45},
        {id: 12, name: 'Kiwano', price: 4.50},
