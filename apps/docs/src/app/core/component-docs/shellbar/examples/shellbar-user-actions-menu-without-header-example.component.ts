...
@Component({
    selector: 'fd-shellbar-user-actions-menu-without-header-example',
    templateUrl: './shellbar-user-actions-menu-without-header-example.component.html'
})
export class ShellbarUserActionsMenuWithoutHeaderExample {
    user: ShellbarUser = {
        fullName: 'John Doe',
