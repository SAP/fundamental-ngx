...
@Component({
    selector: 'fd-shellbar-user-actions-menu-compact-example',
    templateUrl: './shellbar-user-actions-menu-compact-example.component.html'
})
export class ShellbarUserActionsMenuCompactExample {
    user: ShellbarUser = {
        fullName: 'John Doe',
