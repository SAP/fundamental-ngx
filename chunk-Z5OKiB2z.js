import'./main-5LNHRSED.js';var r=`:host {
    ...
    --_ui5_avatar_focus_offset: .125rem;
    ...
    --_ui5_bar_subheader_margin-top: var(--_ui5-light-scheme, -.0625rem) var(--_ui5-dark-scheme, -.125rem);
    ...
    --_ui5_calendar_header_middle_button_focus_after_height: calc(100% - .25rem) ;
    ...
    --ui5_carousel_inactive_dot_size: .5rem;
    --ui5_carousel_inactive_dot_margin: 0 .25rem;
    ...
    --_ui5_card_header_focus_border: .125rem dotted var(--sapContent_FocusColor);
    --_ui5_card_header_focus_radius: 0px;
    --_ui5_card_header_focus_bottom_radius: 0px;
    --_ui5_card_header_focus_offset: 1px;
    --_ui5_card_header_title_font_family: var(--sapFontFamily);
    ...
    --_ui5_color-palette-item-after-focus-border-radius: .125rem;
    --_ui5_color-palette-item-hover-margin: var(--_ui5-compact-size, 0)  var(--_ui5-cozy-size, 0);
    ...
    --_ui5_color-palette-item-before-focus-color: .125rem solid white;
    --_ui5_color-palette-item-before-focus-inset: .0625rem;
    --_ui5_color-palette-item-before-focus-hover-inset: .0625rem;
    --_ui5_color-palette-item-after-focus-color: .125rem dotted black;
    ...
    --_ui5_color-palette-item-hover-outer-border-radius: .25rem;
    --_ui5_color-palette-item-hover-inner-border-radius: .1875rem;
    --_ui5_color-palette-item-selected-focused-border-before: var(--_ui5_color-palette-item-before-focus-hover-inset);
    --_ui5_color-palette-item-after-focus-not-selected-border: .125rem dotted black;
    --_ui5_color-palette-item-after-not-focus-color: .0625rem solid var(--sapGroup_ContentBackground);
    --_ui5_color-palette-item-selected-focused-border: .0625rem solid var(--sapGroup_ContentBackground);
    --_ui5-color-palette-item-mobile-focus-inset: .625rem;
    --_ui5_color-palette-item-mobile-focus-sides-inset: .25rem .25rem;
    ...
    --_ui5_color_picker_slider_handle_box_shadow: inset 0 0 0 .125rem var(--sapContent_ForegroundColor);
    --_ui5_color_picker_slider_handle_border: .125rem solid var(--sapField_BorderColor);
    --_ui5_color_picker_slider_handle_outline_hover: .125rem solid var(--sapButton_Hover_BorderColor);
    --_ui5_color_picker_slider_handle_outline_focus: .0625rem dotted var(--sapContent_FocusColor);
    --_ui5_color_picker_slider_handle_inner_border_color: var(--sapContent_ForegroundColor);
    --_ui5_color_picker_circle_outer_border: .125rem solid var(--sapContent_ContrastShadowColor);
    --_ui5_color_picker_circle_inner_border: var(--sapField_Picker_BorderWidth) solid var(--sapContent_ForegroundColor);
    --_ui5_color_picker_circle_inner_circle_size: .3125rem;
    --_ui5_color_picker_slider_handle_inline_focus: none;
    --_ui5_color_picker_slider_handle_container_margin_top: var(--_ui5-compact-size, .0625rem)  var(--_ui5-cozy-size, none);
    ...
    --_ui5_daypicker_item_selected_text_outline: .0625rem solid var(--sapSelectedColor);
    ...
    --_ui5_daypicker_item_selected__secondary_type_text_outline: .0625rem solid var(--sapSelectedColor);
    ...
    --_ui5_daypicker_item_now_border_focus_after: .125rem solid var(--sapList_SelectionBorderColor);
    ...
    --_ui5_input_custom_icon_padding: var(--_ui5-compact-size, .1875rem .5rem)  var(--_ui5-cozy-size, .5rem .625rem);
    --_ui5_input_error_warning_custom_icon_padding: var(--_ui5-compact-size, .1875rem .5rem)  var(--_ui5-cozy-size, .5rem .625rem);
    --_ui5_input_error_warning_custom_focused_icon_padding: var(--_ui5-compact-size, .1875rem .5rem)  var(--_ui5-cozy-size, .5rem .625rem);
    --_ui5_input_information_custom_icon_padding: var(--_ui5-compact-size, .1875rem .5rem)  var(--_ui5-cozy-size, .5rem .625rem);
    --_ui5_input_information_custom_focused_icon_padding: var(--_ui5-compact-size, .1875rem .5rem)  var(--_ui5-cozy-size, .5rem .625rem);
    --_ui5_input_error_warning_icon_padding: var(--_ui5-compact-size, .1875rem .375rem .1875rem .4375rem)  var(--_ui5-cozy-size, .5rem .5rem .5rem .5625rem);
    --_ui5_input_error_warning_focused_icon_padding: var(--_ui5-compact-size, .1875rem .375rem .1875rem .4375rem)  var(--_ui5-cozy-size, .5rem .5rem .5rem .5625rem);
    --_ui5_input_information_icon_padding: var(--_ui5-compact-size, .1875rem .375rem .1875rem .4375rem)  var(--_ui5-cozy-size, .5rem .5rem .5rem .5625rem);
    --_ui5_input_information_focused_icon_padding: var(--_ui5-compact-size, .1875rem .375rem .1875rem .4375rem)  var(--_ui5-cozy-size, .5rem .5rem .5rem .5625rem);
    ...
    --_ui5_input_icon_padding: var(--_ui5-compact-size, .1875rem .375rem .1875rem .4375rem)  var(--_ui5-cozy-size, .5rem .5rem .5rem .5625rem);
    ...
    --_ui5_message_strip_icon_top: .375rem;
    --_ui5_message_strip_close_button_top: .125rem;
    --_ui5_message_strip_close_button_right: .125rem;
    ...
    --_ui5_panel_focus_border: .125rem dotted var(--sapContent_FocusColor);
    ...
    --_ui5_panel_border_bottom: var(--sapGroup_TitleBorderWidth) solid var(--sapGroup_TitleBorderColor);
    ...
    --_ui5_popup_block_layer_opacity: .3;
    ...
    --_ui5_progress_indicator_border: .0625rem solid var(--sapField_BorderColor);
    ...
    --_ui5_radio_button_border_width: .125rem;
    --_ui5_radio_button_checked_fill: var(--sapContent_IconColor);
    --_ui5_radio_button_checked_error_fill: light-dark(var(--sapContent_IconColor), var(--sapField_InvalidColor));
    --_ui5_radio_button_checked_warning_fill: light-dark(var(--sapContent_IconColor), var(--sapField_TextColor));
    --_ui5_radio_button_checked_success_fill: light-dark(var(--sapContent_IconColor), var(--sapField_SuccessColor));
    --_ui5_radio_button_checked_information_fill: light-dark(var(--sapContent_IconColor), var(--sapField_InformationColor));
    --_ui5_radio_button_warning_error_border_dash: 5;
    --_ui5_radio_button_outer_ring_color: var(--sapField_BorderColor);
    --_ui5_radio_button_outer_ring_width: 2px;
    ...
    --_ui5_rating_indicator_component_spacing: var(--_ui5-compact-size, .5rem 0)  var(--_ui5-cozy-size, .5rem 0px);
    ...
    --_ui5_button_focused_border: .125rem dotted var(--sapContent_FocusColor);
    --_ui5_button_focused_border_radius: .375rem;
    --_ui5_button_focused_inner_border_radius: 0;
    --_ui5_button_base_min_width: var(--_ui5-compact-size, 2rem)  var(--_ui5-cozy-size, 2.5rem);
    ...
    --_ui5_button_base_padding: var(--_ui5-compact-size, .4375rem)  var(--_ui5-cozy-size, .6875rem);
    --_ui5_button_base_icon_margin: .563rem;
    ...
    --_ui5_button_emphasized_border_width: .125rem;
    --_ui5_select_hover_icon_left_border: .0625rem solid var(--sapField_Hover_BorderColor);
    ...
    --_ui5_split_button_transparent_hover_background: var(--sapButton_Hover_Background);
    --_ui5_split_button_host_transparent_hover_background: var(--sapButton_Background);
    ...
    --_ui5_split_button_emphasized_separator_color: var(--sapButton_Emphasized_TextColor);
    --_ui5_split_button_positive_separator_color: var(--sapButton_Accept_BorderColor);
    --_ui5_split_button_negative_separator_color: var(--sapButton_Reject_BorderColor);
    --_ui5_split_button_attention_separator_color: var(--sapButton_Attention_BorderColor);
    --_ui5_split_button_attention_separator_color_default: var(--sapButton_Attention_BorderColor);
    ...
    --_ui5_split_button_host_emphasized_box_shadow: inset 0 0 0 .125rem var(--sapButton_Emphasized_BorderColor);
    ...
    --_ui5_split_text_button_emphasized_border: .125rem solid var(--sapButton_Emphasized_BorderColor);
    --_ui5_split_text_button_emphasized_border_width: .125rem;
    ...
    --_ui5_split_arrow_button_emphasized_hover_border: .0625rem solid var(--sapButton_Emphasized_BorderColor);
    ...
    --_ui5_split_arrow_button_emphasized_hover_box_shadow: inset 0 -.0625rem 0 var(--sapButton_BorderColor), inset -.0625rem 0 0 var(--sapButton_BorderColor), inset 0 .0625rem 0 var(--sapButton_BorderColor);
    --_ui5_split_arrow_button_emphasized_hover_box_shadow_rtl: inset 0 -.0625rem 0 var(--sapButton_BorderColor), inset .0625rem 0 0 var(--sapButton_BorderColor), inset 0 .0625rem 0 var(--sapButton_BorderColor);
    ...
    --_ui5_switch_text_inactive_left_alternate: .0625rem;
    --_ui5_switch_text_inactive_right: auto;
    --_ui5_switch_text_inactive_right_alternate: .125rem;
    --_ui5_switch_text_active_left: var(--_ui5-compact-size, .1875rem)  var(--_ui5-cozy-size, .1875rem);
    --_ui5_switch_text_active_left_alternate: var(--_ui5-compact-size, .0625rem)  var(--_ui5-cozy-size, .0625rem);
    ...
    --_ui5_tc_header_border_bottom: .125rem solid var(--sapPageHeader_BorderColor);
    ...
    --_ui5_tc_headerItem_focus_border: .125rem dotted var(--sapContent_FocusColor);
    ...
    --_ui5_tc_content_border_bottom: .125rem solid var(--sapObjectHeader_BorderColor);
    ...
    --_ui5_textarea_inner_width: 100%;
    --_ui5_textarea_padding_right_and_left: var(--_ui5-compact-size, .375rem)  var(--_ui5-cozy-size, .5rem);
    --_ui5_textarea_padding_right_and_left_error_warning: var(--_ui5-compact-size, .375rem)  var(--_ui5-cozy-size, .5rem);
    --_ui5_textarea_padding_right_and_left_information: var(--_ui5-compact-size, .4375rem)  var(--_ui5-cozy-size, .5625rem);
    --_ui5_textarea_padding_right_and_left_readonly: var(--_ui5-compact-size, .375rem)  var(--_ui5-cozy-size, .5rem);
    --_ui5_textarea_padding_top: var(--_ui5-compact-size, .0625rem)  var(--_ui5-cozy-size, .375rem);
    --_ui5_textarea_padding_bottom: var(--_ui5-compact-size, 0rem)  var(--_ui5-cozy-size, .3125rem);
    --_ui5_textarea_padding_top_readonly: var(--_ui5-compact-size, .0625rem)  var(--_ui5-cozy-size, .375rem);
    --_ui5_textarea_padding_bottom_readonly: var(--_ui5-compact-size, 0rem)  var(--_ui5-cozy-size, .3125rem);
    --_ui5_textarea_padding_top_error_warning: var(--_ui5-compact-size, .0625rem)  var(--_ui5-cozy-size, .375rem);
    --_ui5_textarea_padding_bottom_error_warning: var(--_ui5-compact-size, 0rem)  var(--_ui5-cozy-size, .3125rem);
    --_ui5_textarea_padding_top_information: var(--_ui5-compact-size, .125rem)  var(--_ui5-cozy-size, .4375rem);
    --_ui5_textarea_padding_bottom_information: var(--_ui5-compact-size, .0625rem)  var(--_ui5-cozy-size, .375rem);
    ...
    --_ui5_token_border_radius: .25rem;
    --_ui5_token_focus_outline_width: .125rem;
    ...
    --_ui5_token_focus_offset: var(--_ui5-compact-size, -.125rem)  var(--_ui5-cozy-size, 0);
    --_ui5_token_selected_text_font_family: var(--sapFontFamily);
    --_ui5_token_selected_internal_border_bottom: none;
    --_ui5_token_selected_internal_border_bottom_radius: 0;
    --_ui5_token_focus_outline_border_radius: .25rem;
    ...
    --_ui5_value_state_message_border: var(--sapField_BorderWidth) solid var(--sapField_BorderColor);
    ...
    --_ui5_value_state_header_offset: -.1875rem;
    --_ui5_value_state_message_popover_border_radius: 0;
    --_ui5_value_state_header_box_shadow_error: inset 0 -.125rem var(--sapField_InvalidColor);
    --_ui5_value_state_header_box_shadow_information: inset 0 -.125rem var(--sapField_InformationColor);
    --_ui5_value_state_header_box_shadow_success: inset 0 -.125rem var(--sapField_SuccessColor);
    --_ui5_value_state_header_box_shadow_warning: inset 0 -.125rem var(--sapField_WarningColor);
    ...
    --_ui5_slider_scale_progress_height: .375rem;
    --_ui5_range_slider_progress_focus_display: block;
    --_ui5_range_slider_progress_focus_top: calc(-1 * ((var(--_ui5_slider_handle_height) / 2) + .1875rem) + 2 * var(--_ui5_slider_progress_border_width) - .125rem);
    ...
    --_ui5_step_input_input_margin_top: -.0625rem;
    ...
    --_ui5_step_input_input_border_top_bottom_focused_after: .0625rem;
    ...
    --_ui5_dp_two_calendar_item_secondary_text_padding_block: var(--_ui5-compact-size, 0 .625rem)  var(--_ui5-cozy-size, 0 .5rem);
    ...
    --_ui5_color-palette-item-hover-height: var(--_ui5-compact-size, 1.625rem)  var(--_ui5-cozy-size, 2.375rem);
    --_ui5_color-palette-item-margin: var(--_ui5-compact-size, calc((var(--_ui5_color-palette-item-hover-height) - var(--_ui5_color-palette-item-height)) / 2))  var(--_ui5-cozy-size, calc((var(--_ui5_color-palette-item-hover-height) - var(--_ui5_color-palette-item-height)) / 2));
    --_ui5_color-palette-row-width: var(--_ui5-compact-size, 8.125rem)  var(--_ui5-cozy-size, 12rem);
    --_ui5_color-palette-swatch-container-padding: var(--_ui5-compact-size, .1875rem .8125rem)  var(--_ui5-cozy-size, .3125rem .6875rem);
    ...
    --_ui5_split_button_middle_separator_top: -.0625rem;
    --_ui5_split_button_middle_separator_height: var(--_ui5-compact-size, 1.625rem)  var(--_ui5-cozy-size, 2.25rem);
    ...
    --_ui5_slider_tooltip_height: var(--_ui5-compact-size, 1rem) var(--_ui5-cozy-size, var(--_ui5-f2d95f8));
