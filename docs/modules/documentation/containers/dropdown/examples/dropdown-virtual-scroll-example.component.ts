...
@Component({
    selector: 'fd-dropdown-virtual-scroll-example',
    templateUrl: './dropdown-virtual-scroll-example.component.html'
})
export class DropdownVirtualScrollExampleComponent implements OnInit {
