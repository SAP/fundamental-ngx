...
export class NavbarDocsComponent {
    ...
    <div fd-navbar-group [position]="'left'">
      <div class="fd-global-nav__side-menu">
        <button fd-button [type]="'secondary'" [size]="'l'" [glyph]="'menu2'"></button>
      </div>
    ...
    <div fd-navbar-group [hasLaunchpad]="true">
      <button fd-button [type]="'secondary'" [size]="'l'" [attr.aria-haspopup]="true" [attr.aria-controls]="launchpad">Suite Name</button>
    </div>
    ...
    <div fd-navbar-group [position]="'right'">
      ...
      <div fd-navbar-actions>
        <button fd-button [type]="'secondary'" [size]="'l'" [glyph]="'search'"></button>
        <button fd-button [type]="'secondary'" [size]="'l'" [glyph]="'action-settings'"></button>
