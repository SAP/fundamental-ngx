...
import { PaginationComponent } from '../../../../../../library/src/lib/pagination/pagination.component';

@Component({
    selector: 'fd-pagination-example',
    template: `<fd-pagination [totalItems]="totalItems" (pageChangeStart)="newPageClicked($event)" [itemsPerPage]="itemsPerPage" [currentPage]="currentPage"></fd-pagination>
    <br/><br/>
