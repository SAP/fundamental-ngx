...
export class ActionBarDocsComponent {
  ...
  <fd-action-bar-back>
    <button aria-label="back" fd-button [fdType]="'secondary'" [size]="'compact'" [glyph]="'nav-back'"></button>
  </fd-action-bar-back>
  ...
  <fd-action-bar-actions>
    <fd-popover>
      <fd-popover-control>
        <button aria-label="contextual menu" fd-button [fdType]="'secondary'" [glyph]="'vertical-grip'"></button>
      </fd-popover-control>
      <fd-popover-body>
        <fd-menu>
          <fd-menu-list>
