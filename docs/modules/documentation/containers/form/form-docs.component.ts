    ...
    <fd-form-group>
        <fd-form-item [isInline]="true" [isCheck]="true">
            <fd-form-label [forValue]="'radio-7'">
                <input fd-form-control type="radio" id="radio-7" name="radio-name-3" value="" checked> 
                Option One
            </fd-form-label>
        </fd-form-item>
        <fd-form-item [isInline]="true" [isCheck]="true">
            <fd-form-label [forValue]="'radio-8'">
                <input fd-form-control type="radio" id="radio-8" name="radio-name-3" value=""> 
                Option Two
            </fd-form-label>
        </fd-form-item>
        <fd-form-item [isInline]="true" [isCheck]="true">
            <fd-form-label [forValue]="'radio-9'">
                <input fd-form-control type="radio" id="radio-9" name="radio-name-3" value=""> 
                Option Three
            </fd-form-label>
        </fd-form-item>
    </fd-form-group>
...
<fieldset fd-form-set>
    ...
    <fd-form-item [isCheck]="true">
        <input fd-form-control type="checkbox" id="checkbox-4" name="checkbox-name-2" disabled checked>
        <fd-form-label [forValue]="'checkbox-4'">Option One</fd-form-label>
    </fd-form-item>
    <fd-form-item [isCheck]="true">
        <input fd-form-control type="checkbox" id="checkbox-5" name="checkbox-name-2" disabled>
    ...
    <fd-form-group>
        <fd-form-item [isInline]="true" [isCheck]="true">
            <fd-form-label [forValue]="'checkbox-7'">
                <input fd-form-control type="checkbox" id="checkbox-7" name="checkbox-name-3" checked> 
                Option One
            </fd-form-label>
        </fd-form-item>
        <fd-form-item [isInline]="true" [isCheck]="true">
            <fd-form-label [forValue]="'checkbox-8'">
                <input fd-form-control type="checkbox" id="checkbox-8" name="checkbox-name-3"> 
                Option Two
            </fd-form-label>
        </fd-form-item>
        <fd-form-item [isInline]="true" [isCheck]="true">
            <fd-form-label [forValue]="'checkbox-9'">
                <input fd-form-control type="checkbox" id="checkbox-9" name="checkbox-name-3"> 
                Option Three
            </fd-form-label>
        </fd-form-item>
    </fd-form-group>
