...
<fieldset fd-form-set>
    ...
    <fd-form-group>
        <fd-form-item [isCheck]="true">
            <input fd-form-control type="radio" id="radio-1" name="radio-name-2" value="" checked disabled>
            <fd-form-label [forValue]="'radio-1'">Option One</fd-form-label>
        </fd-form-item>
        <fd-form-item [isCheck]="true">
            <input fd-form-control type="radio" id="radio-2" name="radio-name-2" value="" disabled>
            <fd-form-label [forValue]="'radio-2'">Option Two</fd-form-label>
        </fd-form-item>
        <fd-form-item [isCheck]="true">
            <input fd-form-control type="radio" id="radio-3" name="radio-name-2" value="" disabled>
            <fd-form-label [forValue]="'radio-3'">Option Three</fd-form-label>
        </fd-form-item>
    </fd-form-group>
</fieldset>
...
<fieldset fd-form-set>
    ...
    <fd-form-group>
        <fd-form-item [isInline]="true" [isCheck]="true">
            <fd-form-label [forValue]="'radio-4'">
                <input fd-form-control type="radio" id="radio-4" name="radio-name-3" value="" checked> 
                Option One
            </fd-form-label>
        </fd-form-item>
        <fd-form-item [isInline]="true" [isCheck]="true">
            <fd-form-label [forValue]="'radio-5'">
                <input fd-form-control type="radio" id="radio-5" name="radio-name-3" value=""> 
                Option Two
            </fd-form-label>
        </fd-form-item>
        <fd-form-item [isInline]="true" [isCheck]="true">
            <fd-form-label [forValue]="'radio-6'">
                <input fd-form-control type="radio" id="radio-6" name="radio-name-3" value=""> 
                Option Three
            </fd-form-label>
        </fd-form-item>
    </fd-form-group>
...
<fieldset fd-form-set>
    ...
    <fd-form-item [isCheck]="true">
        <input fd-form-control type="checkbox" id="checkbox-1" name="checkbox-name-1" disabled checked>
        <fd-form-label [forValue]="'checkbox-1'">Option One</fd-form-label>
    </fd-form-item>
    <fd-form-item [isCheck]="true">
        <input fd-form-control type="checkbox" id="checkbox-2" name="checkbox-name-1" disabled>
        <fd-form-label [forValue]="'checkbox-2'">Option Two</fd-form-label>
    </fd-form-item>
    <fd-form-item [isCheck]="true">
        <input fd-form-control type="checkbox" id="checkbox-3" name="checkbox-name-1" disabled>
        <fd-form-label [forValue]="'checkbox-3'">Option Three</fd-form-label>
    </fd-form-item>
</fieldset>
...
<fieldset fd-form-set>
    ...
    <fd-form-group>
        <fd-form-item [isInline]="true" [isCheck]="true">
            <fd-form-label [forValue]="'checkbox-1'">
                <input fd-form-control type="checkbox" id="checkbox-1" name="checkbox-name-1" checked> 
                Option One
            </fd-form-label>
        </fd-form-item>
        <fd-form-item [isInline]="true" [isCheck]="true">
            <fd-form-label [forValue]="'checkbox-2'">
                <input fd-form-control type="checkbox" id="checkbox-2" name="checkbox-name-1"> 
                Option Two
            </fd-form-label>
        </fd-form-item>
        <fd-form-item [isInline]="true" [isCheck]="true">
            <fd-form-label [forValue]="'checkbox-3'">
                <input fd-form-control type="checkbox" id="checkbox-3" name="checkbox-name-1"> 
                Option Three
            </fd-form-label>
        </fd-form-item>
