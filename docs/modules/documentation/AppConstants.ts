 ...
 */
import { SAPIcons } from './IconsSAP'
import { AribaIcons } from './IconsAriba'


// export function toKeys(objectArray): Array {
//   let keyArray = [];
//   for(let i = 0; i < objectArray.length; i++) {
//     keyArray.push(objectArray[i].key);
//   }
//   return keyArray;
// }
...
export class AppConstants  {
  ...
  //static SAPIcons = toKeys(SAPIcons);

  static AribaIcons = AppConstants.toKeys(AribaIcons);

  static componentSizes = ['s', 'default', 'm', 'l', 'xl'];
