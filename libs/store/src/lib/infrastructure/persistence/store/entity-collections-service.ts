...
export abstract class EntityCollectionsService {
     ...
     */
    abstract getEntityCollectionService<T extends BaseEntity>(entityType: EntityType<T>): EntityCollectionService<T>;
    /**
     ...
     */
    abstract registerEntityCollectionService<T extends BaseEntity>(
