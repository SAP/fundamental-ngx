...
/**
 * Regenerate all TypeScript translation files from .properties files
 * This is the core generation logic shared by all i18n operations
 */
export async function regenerateTypeScriptFiles(propertiesPath: string): Promise<SyncResult> {
