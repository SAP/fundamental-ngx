...
export async function removeKey(options: RemoveKeyOptions): Promise<RemoveKeyResult> {
    ...
    for (const tsFile of tsFiles) {
        ...
        try {
            ...
            // If language-specific file exists, overlay its translations
            try {
                const langPropertiesContent = readFileSync(propertiesFile, 'utf-8');
                ...
                // If language-specific file doesn't exist, use base (already loaded above)
            }
