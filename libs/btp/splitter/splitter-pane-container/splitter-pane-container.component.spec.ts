    ...
    template: `
        <fdb-splitter>
            <fdb-splitter-pane-container>
                ...
                <fdb-splitter-split-pane #paneTwo [id]="paneTwoId"> Pane {{ paneTwoId }} </fdb-splitter-split-pane>
            </fdb-splitter-pane-container>
        </fdb-splitter>
    `,
    standalone: true,
    imports: [SplitterComponent, SplitterPaneContainerComponent, SplitterSplitPaneComponent]
})
