...
const platformTableActivableRowSrc = 'platform-table-preserved-state-example.component.html';
const platformTableActivableRowTsSrc = 'platform-table-preserved-state-example.component.ts';
