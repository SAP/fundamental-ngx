...
import { PlatformTableModule, TableDataProvider, TableDataSource } from '@fundamental-ngx/platform/table';
...
export class PlatformTableVirtualScrollWholeRowExampleComponent {
