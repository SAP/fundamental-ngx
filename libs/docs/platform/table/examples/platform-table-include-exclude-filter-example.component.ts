...
@Component({
    selector: 'fdp-platform-table-include-exclude-filter-example',
    templateUrl: './platform-table-include-exclude-filter-example.component.html',
...
export class PlatformTableIncludeExcludeFilterExampleComponent {
