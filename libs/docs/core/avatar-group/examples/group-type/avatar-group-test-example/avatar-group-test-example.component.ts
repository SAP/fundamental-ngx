...
import { AvatarGroupDataExampleService } from './avatar-group-test-example.service';

@Component({
    selector: 'fd-avatar-group-group-test-example',
    templateUrl: 'avatar-group-test-example.component.html',
    standalone: true,
    imports: [
        AvatarGroupComponent,
        AvatarComponent,
...
export class AvatarGroupTypeExampleComponent {
    size: Size = 'l';
    readonly avatarGroupDataExampleService = inject(
        AvatarGroupDataExampleService
    );
