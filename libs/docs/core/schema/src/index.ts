...
export { alertSchema } from './lib/alert.schema';
export { buttonSchema } from './lib/button.schema';
export * from './lib/core-schema.module';
export { dialogSchema } from './lib/dialog.schema';
...
export { tabsSchema } from './lib/tabs.schema';
export { timeSchema } from './lib/time.schema';
