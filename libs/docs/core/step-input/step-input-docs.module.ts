...
import { DeprecatedStepInputCompactDirective, StepInputModule } from '@fundamental-ngx/core/step-input';
...
@NgModule({
    ...
    providers: [moduleDeprecationsProvider(DeprecatedStepInputCompactDirective), currentComponentProvider('step-input')]
})
