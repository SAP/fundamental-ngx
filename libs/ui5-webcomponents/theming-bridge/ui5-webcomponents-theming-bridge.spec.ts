...
import { Ui5WebcomponentsMainThemingService, provideUi5Webcomponents } from './index';
...
jest.mock('@ui5/webcomponents/dist/generated/json-imports/Themes.js', () => ({}));
...
describe('provideUi5Webcomponents', () => {
    afterEach(() => {
    ...
    it('should be exported from the theming-bridge entry point', () => {
        expect(provideUi5Webcomponents).toBeDefined();
        expect(typeof provideUi5Webcomponents).toBe('function');
    });

    it('should force-construct Ui5WebcomponentsMainThemingService', () => {
        TestBed.configureTestingModule({
            providers: [provideUi5Webcomponents()]
        });

        const service = TestBed.inject(Ui5WebcomponentsMainThemingService);
        expect(service).toBeTruthy();
    });
});

describe('provideUi5Webcomponents — integration (real Ui5ThemingService)', () => {
    afterEach(() => {
        mockSetTheme.mockClear();
        TestBed.resetTestingModule();
    });
