...
import { ExperimentalRadioButtonComponent } from './radio-button.component';
...
class TestRadioButtonComponent {
    ...
    @ViewChild('radio1') radioButton1: ExperimentalRadioButtonComponent;
    @ViewChild('radio2') radioButton2: ExperimentalRadioButtonComponent;
    @ViewChild('radio3') radioButton3: ExperimentalRadioButtonComponent;
}
...
describe('RadioButtonComponent', () => {
    ...
    beforeEach(waitForAsync(() => {
        TestBed.configureTestingModule({
            imports: [FormsModule],
            declarations: [ExperimentalRadioButtonComponent, TestRadioButtonComponent],
