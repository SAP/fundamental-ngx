    ...
    ngOnInit(): void {
        ...
        this._tableColumnResizeService.resizerPosition$
            ...
            .subscribe((position) => {
                ...
                this._renderer.setStyle(this._elmRef.nativeElement, 'left', this._isRtl() ? 'auto' : `${position}px`);
                this._renderer.setStyle(this._elmRef.nativeElement, 'right', !this._isRtl() ? 'auto' : `${position}px`);
            });
