...
import { FormGeneratorService } from '../form/form-generator/form-generator.service';
import { WizardGeneratorStepComponent, WizardStepSubmittedForms } from './components/wizard-generator-step/wizard-generator-step.component';
import { WizardGeneratorFormsValue, WizardGeneratorItem, WizardVisibleSteps } from './interfaces/wizard-generator-item.interface';
...
export class WizardGeneratorService {
    ...
    isStepsUntouched(): boolean {
        return ![...this.stepsComponents].some(([_, component]) => component.forms.some((item) => !item.form.pristine));
    }
