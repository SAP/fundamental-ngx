 ...
 */
@Component({
    selector: 'fdp-carosuel',
    templateUrl: './carosuel.component.html',
    styleUrls: ['./carosuel.component.scss'
    ],
    encapsulation: ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class CarosuelComponent implements OnDestroy, AfterViewInit, OnChanges {
    ...
    @Input() public inMiddle = true;
    @Input() public indicatorPosition = 'bottom';
    ...
    @Input() public bottom = true;
    @Input() public content = true;

    /**  count and map the index to slide */
    ...
    /**Display slides in fade animation mode */
