...
@Component({
    selector: 'fdp-test-wrapper-select',
    template: `
        <fdp-select [(value)]="wrapperValue" formControlName="selectControl">
            <fdp-option id="fdtest1" [value]="'test1'">Test1</fdp-option>
            <fdp-option id="fdtest2" [value]="'test2'">Test2</fdp-option>
            <fdp-option id="viewValue1" [value]="'viewValue1'" [viewValue]="'testViewValue'">Test3</fdp-option>
            <div>
                <fdp-option id="nestedOption" [value]="'nestedOption'">Nested</fdp-option>
            </div>
        </fdp-select>
    `
})
