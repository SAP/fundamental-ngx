...
import { AbstractControl, FormControl, NG_VALIDATORS, ValidatorFn, ValidationErrors } from '@angular/forms';

@Directive({
  // tslint:disable-next-line:directive-selector
  selector: '[fdp-condition-count-message]',
  providers: [
    { provide: NG_VALIDATORS, useExisting: ConditionCountMessageDirective, multi: true }
  ]
})
