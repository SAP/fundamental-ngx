export * from './settings-generator.module';
...
export * from './settings-generator-content/settings-generator-content.component';
...
export * from './layouts/settings-generator-sidebar-layout/settings-generator-sidebar-icon/settings-generator-sidebar-icon.component';
export * from './settings-generator-layout-accessor.service';
