...
describe('ApprovalFlowNodeComponent', () => {
    ...
    it('should add blank class', () => {
        ...
        expect(fixture.nativeElement.classList).toContain('fdp-approval-flow-node--blank');
    });
    ...
    it('should toggle line-before & line-after classes', () => {
        ...
        expect(fixture.nativeElement.classList).toContain('fdp-approval-flow-node--line-before');
        expect(fixture.nativeElement.classList).toContain('fdp-approval-flow-node--line-after');
        ...
        expect(fixture.nativeElement.classList).not.toContain('fdp-approval-flow-node--line-before');
        expect(fixture.nativeElement.classList).not.toContain('fdp-approval-flow-node--line-after');
    });
    ...
    it('should have approved class when node is approved', () => {
        ...
        expect(fixture.nativeElement.classList).toContain('fdp-approval-flow-node--approved');
    });
    ...
    it('should add parent-approved class if parent node is approved', () => {
        ...
        expect(fixture.nativeElement.classList).toContain('fdp-approval-flow-node--parent-approved');
    });
