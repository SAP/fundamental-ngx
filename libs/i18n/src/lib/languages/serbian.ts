...
export const FD_LANGUAGE_SERBIAN: FdLanguage = {
    ...
    coreNavigation: { mainNavigation: 'Glavno usmeravanje', navigationPath: 'Put usmeravanja' },
    coreNestedList: {
    ...
    coreShellbar: { collapsedItemMenuLabel: 'Sažeti meni stavke', cancel: 'Otkaži', search: 'Traži' },
    coreSlider: {
    ...
    coreSplitButton: { expandButtonAriaLabel: 'Više radnji', arialLabel: 'Dugme za deljenje' },
    coreSplitter: { paginationItemAriaLabel: 'Odeljak' },
    coreStepInput: {
    ...
    coreTimePicker: { timePickerInputLabel: 'Unos birača vremena', timePickerButtonLabel: 'Otvori birač' },
    coreToken: { deleteButtonLabel: 'Može se izbrisati', ariaRoleDescription: 'token' },
    coreTokenizer: { moreLabel: '{{count}} više', tokenizerLabel: 'Generator tokena' },
    ...
    platformObjectListItem: { detailsActionAriaLabel: 'detalj', deleteActionAriaLabel: 'izbriši' },
    platformStandardListItem: { detailsActionAriaLabel: 'detalj', deleteActionAriaLabel: 'izbriši' },
    platformSearchField: {
    ...
    platformSelect: { selectOptionLabel: 'Odaberi opciju' },
    fnSlider: {
