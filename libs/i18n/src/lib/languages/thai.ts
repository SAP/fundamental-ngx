...
export const FD_LANGUAGE_THAI: FdLanguage = {
    ...
    coreCarousel: { leftNavigationBtnLabel: 'ไปยังไอเท็มก่อนหน้า', rightNavigationBtnLabel: 'ไปยังไอเท็มถัดไป' },
    coreDatePicker: {
    ...
    coreNavigation: { mainNavigation: 'การเนวิเกตหลัก', navigationPath: 'พาธการเนวิเกต' },
    coreNestedList: {
    ...
    coreShellbar: { collapsedItemMenuLabel: 'เมนูไอเท็มแบบยุบรวม', cancel: 'ยกเลิก', search: 'ค้นหา' },
    coreSlider: {
    ...
    coreSplitButton: { expandButtonAriaLabel: 'การดำเนินการเพิ่มเติม', arialLabel: "ปุ่ม 'แยก'" },
    coreSplitter: { paginationItemAriaLabel: 'เซกชัน' },
    coreStepInput: {
        incrementButtonTitle: 'การเพิ่ม',
        decrementButtonTitle: 'การลด',
        ariaRoleDescription: 'อินพุทของขั้นตอน'
    },
    coreSwitch: { semanticAcceptLabel: 'ยอมรับ', semanticDeclineLabel: 'ปฏิเสธ' },
    coreTabs: { tabListExpandButtonText: 'เพิ่มเติม' },
    coreText: { moreLabel: 'เพิ่มเติม', lessLabel: 'น้อยลง' },
    coreTime: {
    ...
    coreTimePicker: { timePickerInputLabel: 'อินพุทของตัวเลือกเวลา', timePickerButtonLabel: 'เปิดตัวเลือก' },
    coreToken: { deleteButtonLabel: 'สามารถลบได้', ariaRoleDescription: 'Token' },
    coreTokenizer: { moreLabel: 'อีก {{count}} รายการ', tokenizerLabel: 'ตัวแปลงเป็น Token' },
    ...
    platformLink: { roleDescriptionWithMedia: 'สื่อ: {{media}}' },
    platformList: { loadingAriaLabel: 'กำลังโหลด' },
    platformObjectListItem: { detailsActionAriaLabel: 'รายละเอียด', deleteActionAriaLabel: 'ลบ' },
    platformStandardListItem: { detailsActionAriaLabel: 'รายละเอียด', deleteActionAriaLabel: 'ลบ' },
    platformSearchField: {
    ...
    platformWizardGenerator: { summarySectionEditStep: 'แก้ไข' },
    ...
    platformVariantManagement: {
        ...
        search: 'ค้นหา',
        access: { public: 'สาธารณะ', private: 'ส่วนบุคคล' }
    },
    platformSelect: { selectOptionLabel: 'เลือกตัวเลือก' },
    fnSlider: {
    ...
    coreTree: { expand: 'ขยายโหนด', collapse: 'ยุบรวมโหนด', noData: 'ไม่มีข้อมูล' }
};
