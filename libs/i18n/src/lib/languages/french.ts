...
export const FD_LANGUAGE_FRENCH: FdLanguage = {
    ...
    coreNavigation: { mainNavigation: 'Navigation principale', navigationPath: 'Chemin de navigation' },
    coreNestedList: {
    ...
    coreShellbar: { collapsedItemMenuLabel: 'Menu des éléments réduits', cancel: 'Annuler', search: 'Rechercher' },
    coreSlider: {
        ...
        multipleHandle1MinMaxDetails:
            'La valeur minimale du curseur de plage est {{min}}, la valeur maximale est {{max}}',
    ...
    coreSplitButton: { expandButtonAriaLabel: "Plus d'actions", arialLabel: 'Bouton de fractionnement' },
    ...
    coreSwitch: { semanticAcceptLabel: 'Accepter', semanticDeclineLabel: 'Refuser' },
    coreTabs: { tabListExpandButtonText: 'Plus' },
    coreText: { moreLabel: 'Plus', lessLabel: 'Moins' },
    coreTime: {
    ...
    coreToken: { deleteButtonLabel: 'Supprimable', ariaRoleDescription: 'jeton' },
    coreTokenizer: { moreLabel: '{{count}} de plus', tokenizerLabel: 'Générateur de jetons' },
    ...
    platformList: { loadingAriaLabel: 'chargement en cours' },
    platformObjectListItem: { detailsActionAriaLabel: 'détails', deleteActionAriaLabel: 'supprimer' },
    platformStandardListItem: { detailsActionAriaLabel: 'détails', deleteActionAriaLabel: 'supprimer' },
    platformSearchField: {
    ...
    platformWizardGenerator: { summarySectionEditStep: 'Modifier' },
    ...
    platformVariantManagement: {
        ...
        search: 'Rechercher',
        access: { public: 'Publique', private: 'Privée' }
    },
    platformSelect: { selectOptionLabel: 'Sélectionner une option' },
    fnSlider: {
    ...
    fnSwitch: { semanticAcceptLabel: 'Accepter', semanticDeclineLabel: 'Refuser' },
    coreTree: { expand: 'Développer le nœud', collapse: 'Réduire le nœud', noData: 'Aucune donnée' }
};
