...
export const FD_LANGUAGE_CHINESE: FdLanguage = {
    ...
    coreFeedListItem: { moreLabel: '另外 {{count}} 个', lessLabel: '更少' },
    coreGridList: {
    ...
    coreNavigation: { mainNavigation: '主导航', navigationPath: '导航路径' },
    ...
    coreShellbar: { collapsedItemMenuLabel: '已折叠项目菜单', cancel: '取消', search: '搜索' },
    coreSlider: {
    ...
    coreSplitButton: { expandButtonAriaLabel: '更多操作', arialLabel: '拆分按钮' },
    coreSplitter: { paginationItemAriaLabel: '区段' },
    coreStepInput: { incrementButtonTitle: '增加', decrementButtonTitle: '减少', ariaRoleDescription: '设置输入' },
    coreSwitch: { semanticAcceptLabel: '接受', semanticDeclineLabel: '拒绝' },
    coreTabs: { tabListExpandButtonText: '更多' },
    coreText: { moreLabel: '更多', lessLabel: '更少' },
    coreTime: {
    ...
    coreTimePicker: { timePickerInputLabel: '时间选取器输入', timePickerButtonLabel: '打开选取器' },
    coreToken: { deleteButtonLabel: '可删除', ariaRoleDescription: '令牌' },
    coreTokenizer: { moreLabel: '另外 {{count}} 个', tokenizerLabel: '分词器' },
    ...
    platformFeedInput: { userTitle: '用户' },
    platformVHD: {
    ...
    platformCombobox: { countListResultsSingular: '1 个结果列表项目', countListResultsPlural: '{{0}} 个结果列表项目' },
    ...
    platformLink: { roleDescriptionWithMedia: '媒体：{{media}}' },
    platformList: { loadingAriaLabel: '正在加载' },
    platformObjectListItem: { detailsActionAriaLabel: '详细信息', deleteActionAriaLabel: '删除' },
    platformStandardListItem: { detailsActionAriaLabel: '详细信息', deleteActionAriaLabel: '删除' },
    platformSearchField: {
        clearButtonTitle: '清除',
    ...
    platformWizardGenerator: { summarySectionEditStep: '编辑' },
    ...
    platformVariantManagement: {
        ...
        removeVariant: '删除视图',
        search: '搜索',
        access: { public: '公共', private: '私人' }
    },
    platformSelect: { selectOptionLabel: '选择选项' },
    fnSlider: {
    ...
    fnSwitch: { semanticAcceptLabel: '接受', semanticDeclineLabel: '拒绝' },
    coreTree: { expand: '展开节点', collapse: '折叠节点', noData: '无数据' }
};
