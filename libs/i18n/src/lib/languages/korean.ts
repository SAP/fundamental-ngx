...
export const FD_LANGUAGE_KOREAN: FdLanguage = {
    ...
    coreCarousel: { leftNavigationBtnLabel: '이전 항목으로 이동', rightNavigationBtnLabel: '다음 항목으로 이동' },
    coreDatePicker: {
    ...
    coreNavigation: { mainNavigation: '기본 탐색', navigationPath: '탐색 경로' },
    ...
    coreShellbar: { collapsedItemMenuLabel: '접힌 항목 메뉴', cancel: '취소', search: '검색' },
    coreSlider: {
    ...
    coreSplitButton: { expandButtonAriaLabel: '추가 조치', arialLabel: '분할 버튼' },
    coreSplitter: { paginationItemAriaLabel: '섹션' },
    coreStepInput: { incrementButtonTitle: '증분', decrementButtonTitle: '감소', ariaRoleDescription: '단계 입력' },
    coreSwitch: { semanticAcceptLabel: '수락', semanticDeclineLabel: '거부' },
    coreTabs: { tabListExpandButtonText: '더 보기' },
    coreText: { moreLabel: '더 보기', lessLabel: '간단히' },
    coreTime: {
    ...
    coreTimePicker: { timePickerInputLabel: '시간 선택 도구 입력', timePickerButtonLabel: '선택 도구 열기' },
    coreToken: { deleteButtonLabel: '삭제 가능', ariaRoleDescription: '토큰' },
    coreTokenizer: { moreLabel: '{{count}}개 더 보기', tokenizerLabel: '토크나이저' },
    ...
    platformFeedInput: { userTitle: '사용자' },
    platformVHD: {
    ...
    platformLink: { roleDescriptionWithMedia: '미디어: {{media}}' },
    platformList: { loadingAriaLabel: '로드 중' },
    platformObjectListItem: { detailsActionAriaLabel: '세부사항', deleteActionAriaLabel: '삭제' },
    platformStandardListItem: { detailsActionAriaLabel: '세부사항', deleteActionAriaLabel: '삭제' },
    platformSearchField: {
    ...
    platformWizardGenerator: { summarySectionEditStep: '편집' },
    ...
    platformSelect: { selectOptionLabel: '옵션 선택' },
    fnSlider: {
    ...
    coreTree: { expand: '노드 펼치기', collapse: '노드 접기', noData: '데이터 없음' }
};
