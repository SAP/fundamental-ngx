...
export const FD_LANGUAGE_SLOVENIAN: FdLanguage = {
    ...
    coreNavigation: { mainNavigation: 'Glavno krmarjenje', navigationPath: 'Pot krmarjenja' },
    coreNestedList: {
    ...
    coreShellbar: { collapsedItemMenuLabel: 'Skrčeni meni s postavkami', cancel: 'Prekliči', search: 'Iskanje' },
    coreSlider: {
    ...
    coreSplitButton: { expandButtonAriaLabel: 'Več dejanj', arialLabel: 'Razdelilni gumb' },
    coreSplitter: { paginationItemAriaLabel: 'Razdelek' },
    coreStepInput: {
        incrementButtonTitle: 'Povečanje',
        decrementButtonTitle: 'Zmanjšanje',
        ariaRoleDescription: 'Vnos koraka'
    },
    coreSwitch: { semanticAcceptLabel: 'Sprejmi', semanticDeclineLabel: 'Odkloni' },
    coreTabs: { tabListExpandButtonText: 'Več' },
    coreText: { moreLabel: 'Več', lessLabel: 'Manj' },
    coreTime: {
    ...
    coreTimePicker: { timePickerInputLabel: 'Vnos izbirnika časa', timePickerButtonLabel: 'Odpiranje izbirnika' },
    coreToken: { deleteButtonLabel: 'Z možnostjo izbrisa', ariaRoleDescription: 'žeton' },
    coreTokenizer: { moreLabel: 'Še {{count}}', tokenizerLabel: 'Generator žetonov' },
    ...
    platformList: { loadingAriaLabel: 'nalaganje' },
    platformObjectListItem: { detailsActionAriaLabel: 'podrobnost', deleteActionAriaLabel: 'izbriši' },
    platformStandardListItem: { detailsActionAriaLabel: 'podrobnost', deleteActionAriaLabel: 'izbriši' },
    platformSearchField: {
    ...
    platformVariantManagement: {
        ...
        search: 'Iskanje',
        access: { public: 'Javno', private: 'Zasebno' }
    },
    platformSelect: { selectOptionLabel: 'Izberi možnost' },
    fnSlider: {
    ...
    coreTree: { expand: 'Razširitev vozlišča', collapse: 'Skrčitev vozlišča', noData: 'Ni podatkov' }
};
