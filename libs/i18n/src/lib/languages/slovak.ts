...
export const FD_LANGUAGE_SLOVAK: FdLanguage = {
    ...
    coreNavigation: { mainNavigation: 'Hlavná navigácia', navigationPath: 'Cesta navigácie' },
    coreNestedList: {
    ...
    coreShellbar: { collapsedItemMenuLabel: 'Zbalená ponuka položiek', cancel: 'Zrušiť', search: 'Vyhľadávanie' },
    coreSlider: {
    ...
    coreSplitButton: { expandButtonAriaLabel: 'Ďalšie akcie', arialLabel: 'Tlačidlo rozdelenia' },
    coreSplitter: { paginationItemAriaLabel: 'Sekcia' },
    coreStepInput: {
        incrementButtonTitle: 'Nárast',
        decrementButtonTitle: 'Úbytok',
        ariaRoleDescription: 'Zadanie kroku'
    },
    coreSwitch: { semanticAcceptLabel: 'Prijať', semanticDeclineLabel: 'Zamietnuť' },
    coreTabs: { tabListExpandButtonText: 'Ďalšie' },
    coreText: { moreLabel: 'Ďalšie', lessLabel: 'Menej' },
    coreTime: {
    ...
    coreTimePicker: { timePickerInputLabel: 'Zadanie pre výber času', timePickerButtonLabel: 'Otvoriť výber' },
    coreToken: { deleteButtonLabel: 'Vymazateľné', ariaRoleDescription: 'token' },
    coreTokenizer: { moreLabel: '{{count}} viac', tokenizerLabel: 'Tokenizér' },
    ...
    platformLink: { roleDescriptionWithMedia: 'Médiá: {{media}}' },
    platformList: { loadingAriaLabel: 'načítava sa' },
    platformObjectListItem: { detailsActionAriaLabel: 'Detail', deleteActionAriaLabel: 'Odstrániť' },
    platformStandardListItem: { detailsActionAriaLabel: 'Detail', deleteActionAriaLabel: 'Odstrániť' },
    platformSearchField: {
    ...
    platformWizardGenerator: { summarySectionEditStep: 'Upraviť' },
    ...
    platformVariantManagement: {
        ...
        search: 'Vyhľadávanie',
        access: { public: 'Verejné', private: 'Súkromné' }
    },
    platformSelect: { selectOptionLabel: 'Vyberte možnosť' },
    fnSlider: {
    ...
    coreTree: { expand: 'Rozbaliť uzol', collapse: 'Zbaliť uzol', noData: 'Žiadne dáta' }
};
