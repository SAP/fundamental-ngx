...
export const FD_LANGUAGE_CHINESE_TRADITIONAL: FdLanguage = {
    ...
    coreCarousel: { leftNavigationBtnLabel: '移至先前項目', rightNavigationBtnLabel: '移至下一個項目' },
    coreDatePicker: {
        dateInputLabel: '日期輸入',
    ...
    coreNavigation: { mainNavigation: '主瀏覽', navigationPath: '瀏覽路徑' },
    ...
    coreShellbar: { collapsedItemMenuLabel: '摺疊項目功能表', cancel: '取消', search: '搜尋' },
    coreSlider: {
    ...
    coreSplitButton: { expandButtonAriaLabel: '更多動作', arialLabel: '拆分按鈕' },
    coreSplitter: { paginationItemAriaLabel: '區段' },
    coreStepInput: { incrementButtonTitle: '增加', decrementButtonTitle: '減少', ariaRoleDescription: '步驟輸入' },
    coreSwitch: { semanticAcceptLabel: '接受', semanticDeclineLabel: '拒絕' },
    coreTabs: { tabListExpandButtonText: '更多' },
    coreText: { moreLabel: '更多', lessLabel: '較少' },
    coreTime: {
    ...
    coreTimePicker: { timePickerInputLabel: '時間選擇器輸入', timePickerButtonLabel: '開啟選擇器' },
    coreToken: { deleteButtonLabel: '可刪除', ariaRoleDescription: '權杖' },
    coreTokenizer: { moreLabel: '還有 {{count}} 個', tokenizerLabel: '賦予器' },
    ...
    platformFeedInput: { userTitle: '使用者' },
    platformVHD: {
    ...
    platformLink: { roleDescriptionWithMedia: '媒體：{{media}}' },
    platformList: { loadingAriaLabel: '正在載入' },
    platformObjectListItem: { detailsActionAriaLabel: '詳細資訊', deleteActionAriaLabel: '刪除' },
    platformStandardListItem: { detailsActionAriaLabel: '詳細資訊', deleteActionAriaLabel: '刪除' },
    platformSearchField: {
        clearButtonTitle: '清除',
    ...
    platformWizardGenerator: { summarySectionEditStep: '編輯' },
    ...
    platformSelect: { selectOptionLabel: '選擇選項' },
    fnSlider: {
    ...
    coreTree: { expand: '展開節點', collapse: '收合節點', noData: '無資料' }
};
