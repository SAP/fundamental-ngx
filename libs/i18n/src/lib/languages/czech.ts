...
export const FD_LANGUAGE_CZECH: FdLanguage = {
    ...
    coreFeedListItem: { moreLabel: 'další(ch) {{count}}', lessLabel: 'Méně' },
    coreGridList: {
    ...
    coreNavigation: { mainNavigation: 'Hlavní navigace', navigationPath: 'Navigační cesta' },
    coreNestedList: {
    ...
    coreShellbar: { collapsedItemMenuLabel: 'Sbalená položka menu', cancel: 'Zrušit', search: 'Hledat' },
    coreSlider: {
    ...
    coreSplitButton: { expandButtonAriaLabel: 'Další akce', arialLabel: 'Vícefunkční (rozdělené) tlačítko' },
    coreSplitter: { paginationItemAriaLabel: 'Sekce' },
    coreStepInput: {
        incrementButtonTitle: 'Zvýšení',
        decrementButtonTitle: 'Snížení',
        ariaRoleDescription: 'Zadání kroku'
    },
    coreSwitch: { semanticAcceptLabel: 'Přijmout', semanticDeclineLabel: 'Odmítnout' },
    coreTabs: { tabListExpandButtonText: 'Více' },
    coreText: { moreLabel: 'Více', lessLabel: 'Méně' },
    coreTime: {
    ...
    coreTimePicker: { timePickerInputLabel: 'Zadání výběru času', timePickerButtonLabel: 'Otevřít nástroj pro výběr' },
    coreToken: { deleteButtonLabel: 'Lze odstranit', ariaRoleDescription: 'token' },
    coreTokenizer: { moreLabel: 'další(ch) {{count}}', tokenizerLabel: 'Tokenizér' },
    ...
    platformFeedInput: { userTitle: 'Uživatel' },
    platformVHD: {
    ...
    platformList: { loadingAriaLabel: 'načítání' },
    platformObjectListItem: { detailsActionAriaLabel: 'detail', deleteActionAriaLabel: 'odstranit' },
    platformStandardListItem: { detailsActionAriaLabel: 'detail', deleteActionAriaLabel: 'odstranit' },
    platformSearchField: {
    ...
    platformWizardGenerator: { summarySectionEditStep: 'Upravit' },
    ...
    platformVariantManagement: {
        ...
        search: 'Hledat',
        access: { public: 'Veřejný', private: 'Soukromý' }
    },
    platformSelect: { selectOptionLabel: 'Vyberte možnost' },
    fnSlider: {
    ...
    fnSwitch: { semanticAcceptLabel: 'Akceptovat', semanticDeclineLabel: 'Odmítnout' },
    coreTree: { expand: 'Rozbalit uzel', collapse: 'Sbalit uzel', noData: 'Žádná data' }
};
