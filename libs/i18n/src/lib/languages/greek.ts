...
export const FD_LANGUAGE_GREEK: FdLanguage = {
    ...
    coreNavigation: { mainNavigation: 'Κύρια Πλοήγηση', navigationPath: 'Διαδρομή Πλοήγησης' },
    coreNestedList: {
    ...
    coreShellbar: { collapsedItemMenuLabel: 'Συνεπτυγμένο Μενού Στοιχείων', cancel: 'Ακύρωση', search: 'Αναζήτηση' },
    coreSlider: {
    ...
    coreSplitButton: { expandButtonAriaLabel: 'Περισσότερες ενέργειες', arialLabel: 'Κουμπί επιμερισμού' },
    coreSplitter: { paginationItemAriaLabel: 'Ενότητα' },
    coreStepInput: {
        incrementButtonTitle: 'Αύξηση',
        decrementButtonTitle: 'Μείωση',
        ariaRoleDescription: 'Είσοδος βήματος'
    },
    coreSwitch: { semanticAcceptLabel: 'Αποδοχή', semanticDeclineLabel: 'Απόρριψη' },
    coreTabs: { tabListExpandButtonText: 'Περισσότερα' },
    coreText: { moreLabel: 'Περισσότερα', lessLabel: 'Λιγότερα' },
    coreTime: {
    ...
    coreTimePicker: { timePickerInputLabel: 'Είσοδος επιλογέα χρόνου', timePickerButtonLabel: 'Ανοιγμα επιλογέα' },
    coreToken: { deleteButtonLabel: 'Διαγράψιμο', ariaRoleDescription: 'διακριτικό' },
    coreTokenizer: { moreLabel: '{{count}} περισσότερα', tokenizerLabel: 'Δημιουργία διακριτικού' },
    ...
    platformLink: { roleDescriptionWithMedia: 'Μέσα: {{media}}' },
    platformList: { loadingAriaLabel: 'φόρτωση' },
    platformObjectListItem: { detailsActionAriaLabel: 'αναλυτικό', deleteActionAriaLabel: 'διαγραφή' },
    platformStandardListItem: { detailsActionAriaLabel: 'αναλυτικό', deleteActionAriaLabel: 'διαγραφή' },
    platformSearchField: {
    ...
    platformWizardGenerator: { summarySectionEditStep: 'Επεξεργασία' },
    ...
    platformVariantManagement: {
        ...
        search: 'Αναζήτηση',
        access: { public: 'Δημόσια', private: 'Ιδιωτική' }
    },
    platformSelect: { selectOptionLabel: 'Επιλογή ως Ιδιότητα' },
    fnSlider: {
    ...
    coreTree: { expand: 'Επέκταση κόμβου', collapse: 'Σύμπτυξη κόμβου', noData: 'Χωρίς δεδομένα' }
};
