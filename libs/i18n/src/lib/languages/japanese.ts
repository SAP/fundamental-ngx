...
export const FD_LANGUAGE_JAPANESE: FdLanguage = {
    ...
    coreCarousel: { leftNavigationBtnLabel: '前の項目へ', rightNavigationBtnLabel: '次の項目へ' },
    coreDatePicker: {
        dateInputLabel: '日付入力',
    ...
    coreNavigation: { mainNavigation: 'メインナビゲーション', navigationPath: 'ナビゲーションパス' },
    ...
    coreShellbar: { collapsedItemMenuLabel: '非表示の項目メニュー', cancel: 'キャンセル', search: '検索' },
    coreSlider: {
    ...
    coreSplitButton: { expandButtonAriaLabel: 'その他のアクション', arialLabel: '分割ボタン' },
    coreSplitter: { paginationItemAriaLabel: 'セクション' },
    coreStepInput: {
        incrementButtonTitle: '増やす',
        decrementButtonTitle: '減らす',
        ariaRoleDescription: '手順の入力'
    },
    coreSwitch: { semanticAcceptLabel: '受入', semanticDeclineLabel: '拒否' },
    coreTabs: { tabListExpandButtonText: '表示を増やす' },
    coreText: { moreLabel: '表示を増やす', lessLabel: '表示を減らす' },
    coreTime: {
    ...
    coreTimePicker: { timePickerInputLabel: '時刻選択の入力', timePickerButtonLabel: '日付選択を開く' },
    coreToken: { deleteButtonLabel: '削除可能', ariaRoleDescription: 'トークン' },
    coreTokenizer: { moreLabel: 'ほか{{count}}件', tokenizerLabel: 'トークン化プログラム' },
    ...
    platformFeedInput: { userTitle: 'ユーザー' },
    platformVHD: {
    ...
    platformLink: { roleDescriptionWithMedia: 'メディア: {{media}}' },
    platformList: { loadingAriaLabel: 'ロード中' },
    platformObjectListItem: { detailsActionAriaLabel: '詳細', deleteActionAriaLabel: '削除' },
    platformStandardListItem: { detailsActionAriaLabel: '詳細', deleteActionAriaLabel: '削除' },
    platformSearchField: {
    ...
    platformWizardGenerator: { summarySectionEditStep: '編集' },
    ...
    platformVariantManagement: {
        ...
        search: '検索',
        access: { public: '公開', private: '非公開' }
    },
    platformSelect: { selectOptionLabel: 'オプションを選択' },
    fnSlider: {
    ...
    coreTree: { expand: 'ノードを展開', collapse: 'ノードを圧縮', noData: 'データなし' }
};
