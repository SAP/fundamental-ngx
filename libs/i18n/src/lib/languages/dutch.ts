...
export const FD_LANGUAGE_DUTCH: FdLanguage = {
    ...
    coreCarousel: { leftNavigationBtnLabel: 'Naar vorige item', rightNavigationBtnLabel: 'Naar volgende item' },
    coreDatePicker: {
    ...
    coreNavigation: { mainNavigation: 'Hoofdnavigatie', navigationPath: 'Navigatiepad' },
    coreNestedList: {
    ...
    coreShellbar: { collapsedItemMenuLabel: 'Menu-item samengevouwen', cancel: 'Annuleren', search: 'Zoeken' },
    coreSlider: {
        ...
        multipleHandle1MinMaxDetails:
            'Minimumwaarde voor schuifregelaar voor bereik is {{min}}, maximumwaarde is {{max}}',
    ...
    coreSplitButton: { expandButtonAriaLabel: 'Meer acties', arialLabel: 'Knop Splitsen' },
    coreSplitter: { paginationItemAriaLabel: 'Sectie' },
    coreStepInput: {
        incrementButtonTitle: 'Verhogen',
        decrementButtonTitle: 'Verlagen',
        ariaRoleDescription: 'Stapinvoer'
    },
    coreSwitch: { semanticAcceptLabel: 'Accepteren', semanticDeclineLabel: 'Weigeren' },
    coreTabs: { tabListExpandButtonText: 'Meer' },
    coreText: { moreLabel: 'Meer', lessLabel: 'Minder' },
    coreTime: {
    ...
    coreTimePicker: { timePickerInputLabel: 'Invoer tijdkiezer', timePickerButtonLabel: 'Kiezer openen' },
    coreToken: { deleteButtonLabel: 'Verwijderbaar', ariaRoleDescription: 'token' },
    coreTokenizer: { moreLabel: 'nog {{count}}', tokenizerLabel: 'Tokenizer' },
    ...
    platformList: { loadingAriaLabel: 'laden' },
    platformObjectListItem: { detailsActionAriaLabel: 'detail', deleteActionAriaLabel: 'verwijderen' },
    platformStandardListItem: { detailsActionAriaLabel: 'detail', deleteActionAriaLabel: 'verwijderen' },
    platformSearchField: {
    ...
    platformWizardGenerator: { summarySectionEditStep: 'Bewerken' },
    ...
    platformVariantManagement: {
        ...
        search: 'Zoeken',
        access: { public: 'Openbaar', private: 'Privé' }
    },
    platformSelect: { selectOptionLabel: 'Selecteer een optie' },
    fnSlider: {
    ...
    coreTree: { expand: 'Knooppunt uitvouwen', collapse: 'Knooppunt samenvouwen', noData: 'Geen gegevens' }
};
