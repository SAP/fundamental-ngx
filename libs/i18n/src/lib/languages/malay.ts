...
export const FD_LANGUAGE_MALAY: FdLanguage = {
    ...
    coreNavigation: { mainNavigation: 'Navigasi Utama', navigationPath: 'Laluan Navigasi' },
    coreNestedList: {
    ...
    coreShellbar: { collapsedItemMenuLabel: 'Menu Item yang Diruntuhkan', cancel: 'Batal', search: 'Cari' },
    coreSlider: {
    ...
    coreSplitButton: { expandButtonAriaLabel: 'Tindakan selanjutnya', arialLabel: 'Butang pisahan' },
    coreSplitter: { paginationItemAriaLabel: 'Bahagian' },
    coreStepInput: {
        incrementButtonTitle: 'Kenaikan',
        decrementButtonTitle: 'Pengurangan',
        ariaRoleDescription: 'Input Langkah'
    },
    coreSwitch: { semanticAcceptLabel: 'Terima', semanticDeclineLabel: 'Tolak' },
    coreTabs: { tabListExpandButtonText: 'Selanjutnya' },
    coreText: { moreLabel: 'Selanjutnya', lessLabel: 'Kurang' },
    coreTime: {
    ...
    coreTimePicker: { timePickerInputLabel: 'Input pemilih masa', timePickerButtonLabel: 'Buka pemilih' },
    coreToken: { deleteButtonLabel: 'Boleh Padam', ariaRoleDescription: 'token' },
    coreTokenizer: { moreLabel: '{{count}} selanjutnya', tokenizerLabel: 'Pengawal Token' },
    ...
    platformList: { loadingAriaLabel: 'memuatkan' },
    platformObjectListItem: { detailsActionAriaLabel: 'butiran', deleteActionAriaLabel: 'padam' },
    platformStandardListItem: { detailsActionAriaLabel: 'butiran', deleteActionAriaLabel: 'padam' },
    platformSearchField: {
    ...
    platformVariantManagement: {
        ...
        search: 'Cari',
        access: { public: 'Awam', private: 'Persendirian' }
    },
    platformSelect: { selectOptionLabel: 'Pilih Pilihan' },
    fnSlider: {
    ...
    coreTree: { expand: 'Kembangkan nod', collapse: 'Runtuhkan nod', noData: 'Tiada data' }
};
