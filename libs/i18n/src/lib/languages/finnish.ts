...
export const FD_LANGUAGE_FINNISH: FdLanguage = {
    ...
    coreNavigation: { mainNavigation: 'Päänavigointi', navigationPath: 'Navigointipolku' },
    coreNestedList: { linkItemAriaLabel: 'Puun kohde {{itemDetails}}, {{index}} of {{total}}{{selectedDescription}}' },
    ...
    coreShellbar: { collapsedItemMenuLabel: 'Tiivistetty kohteen valikko', cancel: 'Peruuta', search: 'Hae' },
    coreSlider: {
    ...
    coreSplitButton: { expandButtonAriaLabel: 'Enemmän toimia', arialLabel: 'Jaa-painike' },
    coreSplitter: { paginationItemAriaLabel: 'Osio' },
    coreStepInput: {
        incrementButtonTitle: 'Lisäys',
        decrementButtonTitle: 'Vähennys',
        ariaRoleDescription: 'Vaiheen syöttö'
    },
    coreSwitch: { semanticAcceptLabel: 'Hyväksy', semanticDeclineLabel: 'Hylkää' },
    coreTabs: { tabListExpandButtonText: 'Enemmän' },
    coreText: { moreLabel: 'Enemmän', lessLabel: 'Vähemmän' },
    coreTime: {
    ...
    coreTimePicker: { timePickerInputLabel: 'Aikavalitsimen syöttö', timePickerButtonLabel: 'Avaa valitsin' },
    coreToken: { deleteButtonLabel: 'Poistettavissa', ariaRoleDescription: 'tunnus' },
    coreTokenizer: { moreLabel: '{{count}} enemmän', tokenizerLabel: 'Jäsentäjä' },
    ...
    platformList: { loadingAriaLabel: 'ladataan' },
    platformObjectListItem: { detailsActionAriaLabel: 'lisätieto', deleteActionAriaLabel: 'poista' },
    platformStandardListItem: { detailsActionAriaLabel: 'lisätieto', deleteActionAriaLabel: 'poista' },
    platformSearchField: {
    ...
    platformWizardGenerator: { summarySectionEditStep: 'Muokkaa' },
    ...
    platformVariantManagement: {
        ...
        search: 'Hae',
        access: { public: 'Julkinen', private: 'Yksityinen' }
    },
    platformSelect: { selectOptionLabel: 'Valitse jokin vaihtoehto' },
    fnSlider: {
    ...
    coreTree: { expand: 'Laajenna solmu', collapse: 'Tiivistä solmu', noData: 'Ei tietoja' }
};
