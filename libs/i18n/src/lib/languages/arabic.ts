...
export const FD_LANGUAGE_ARABIC: FdLanguage = {
    ...
    coreNavigation: { mainNavigation: 'التنقل الرئيسي', navigationPath: 'مسار التنقل' },
    ...
    coreShellbar: { collapsedItemMenuLabel: 'قائمة عناصر تم طيها', cancel: 'إلغاء', search: 'بحث' },
    coreSlider: {
    ...
    coreSplitButton: { expandButtonAriaLabel: 'مزيد من الإجراءات', arialLabel: 'الزر ’تقسيم‘' },
    coreSplitter: { paginationItemAriaLabel: 'القسم' },
    coreStepInput: {
        incrementButtonTitle: 'زيادة',
        decrementButtonTitle: 'تخفيض',
        ariaRoleDescription: 'إدخال الخطوة'
    },
    coreSwitch: { semanticAcceptLabel: 'قبول', semanticDeclineLabel: 'رفض' },
    coreTabs: { tabListExpandButtonText: 'المزيد' },
    coreText: { moreLabel: 'المزيد', lessLabel: 'أقل' },
    coreTime: {
    ...
    coreTimePicker: { timePickerInputLabel: 'إدخال أداة انتقاء الوقت', timePickerButtonLabel: 'فتح أداة الانتقاء' },
    coreToken: { deleteButtonLabel: 'قابل للحذف', ariaRoleDescription: 'الرمز المميز' },
    coreTokenizer: { moreLabel: '{{count}} إضافية', tokenizerLabel: 'أداة التقسيم إلى رموز مميزة' },
    ...
    platformLink: { roleDescriptionWithMedia: 'الوسائط: {{media}}' },
    platformList: { loadingAriaLabel: 'قيد التحميل' },
    platformObjectListItem: { detailsActionAriaLabel: 'التفاصيل', deleteActionAriaLabel: 'حذف' },
    platformStandardListItem: { detailsActionAriaLabel: 'التفاصيل', deleteActionAriaLabel: 'حذف' },
    platformSearchField: {
    ...
    platformWizardGenerator: { summarySectionEditStep: 'تحرير' },
    ...
    platformVariantManagement: {
        ...
        search: 'بحث',
        access: { public: 'عام', private: 'خاص' }
    },
    platformSelect: { selectOptionLabel: 'تحديد خيار' },
    fnSlider: {
    ...
    coreTree: { expand: 'توسيع العقدة', collapse: 'طي العقدة', noData: 'لا توجد بيانات' }
};
