...
export const FD_LANGUAGE_POLISH: FdLanguage = {
    ...
    coreFeedListItem: { moreLabel: '{{count}} więcej', lessLabel: 'Mniej' },
    coreGridList: {
    ...
    coreNavigation: { mainNavigation: 'Nawigacja główna', navigationPath: 'Ścieżka nawigacji' },
    coreNestedList: {
    ...
    coreShellbar: { collapsedItemMenuLabel: 'Zwinięte menu pozycji', cancel: 'Anuluj', search: 'Szukaj' },
    coreSlider: {
    ...
    coreSplitButton: { expandButtonAriaLabel: 'Więcej czynności', arialLabel: 'Przycisk podzielony na dwie części' },
    coreSplitter: { paginationItemAriaLabel: 'Sekcja' },
    coreStepInput: {
        incrementButtonTitle: 'Zwiększenie',
        decrementButtonTitle: 'Zmniejszenie',
        ariaRoleDescription: 'Dane wejściowe kroku'
    },
    coreSwitch: { semanticAcceptLabel: 'Akceptuj', semanticDeclineLabel: 'Oddal' },
    coreTabs: { tabListExpandButtonText: 'Więcej' },
    coreText: { moreLabel: 'Więcej', lessLabel: 'Mniej' },
    coreTime: {
    ...
    coreTimePicker: { timePickerInputLabel: 'Wpis selektora czasu', timePickerButtonLabel: 'Otwórz selektor' },
    coreToken: { deleteButtonLabel: 'Usuwalne', ariaRoleDescription: 'token' },
    coreTokenizer: { moreLabel: '{{count}} więcej', tokenizerLabel: 'Tokenizer' },
    ...
    platformList: { loadingAriaLabel: 'ładowanie' },
    platformObjectListItem: { detailsActionAriaLabel: 'szczegóły', deleteActionAriaLabel: 'usuń' },
    platformStandardListItem: { detailsActionAriaLabel: 'szczegóły', deleteActionAriaLabel: 'usuń' },
    platformSearchField: {
    ...
    platformWizardGenerator: { summarySectionEditStep: 'Edytuj' },
    ...
    platformVariantManagement: {
        ...
        search: 'Szukaj',
        access: { public: 'Publiczne', private: 'Prywatne' }
    },
    platformSelect: { selectOptionLabel: 'Wybierz opcję' },
    fnSlider: {
    ...
    fnSwitch: { semanticAcceptLabel: 'Zatwierdz', semanticDeclineLabel: 'Odrzuć' },
    coreTree: { expand: 'Rozwiń węzeł', collapse: 'Zwiń węzeł', noData: 'Brak danych' }
};
