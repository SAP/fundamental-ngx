...
import { CHINESE_SIMPLIFIED_ALIASES, CHINESE_TRADITIONAL_ALIASES, registerLanguage } from './utils/detect-language';
 ...
 * @internal
 */
export const ALL_BUILTIN_LANGUAGES: Array<{ lang: FdLanguage; aliases?: readonly string[] }> = [
    { lang: FD_LANGUAGE_ALBANIAN },
    { lang: FD_LANGUAGE_ARABIC },
    { lang: FD_LANGUAGE_BULGARIAN },
    { lang: FD_LANGUAGE_CHINESE_SIMPLIFIED, aliases: CHINESE_SIMPLIFIED_ALIASES },
    { lang: FD_LANGUAGE_CHINESE_TRADITIONAL, aliases: CHINESE_TRADITIONAL_ALIASES },
