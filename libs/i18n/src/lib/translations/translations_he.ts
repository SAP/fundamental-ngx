...
export default {
    ...
    btpSearchField: {
        ...
        searchInputAriaLabel: 'חפש',
        searchInputPlaceholder: 'חפש'
    },
    btpToolHeader: {
    ...
    coreAvatarGroup: {
        ariaLabelGroup:
            'בעל אוואטרים משותפים של דיאלוג מסוג חלון Popup, {count} אוואטארים מוצגים, {hiddenCount} אוואטארים מוסתרים, הפעל לקבלת רשימה מלאה',
        ariaLabelIndividual: 'אוואטארים יחידים {count}אוואטארים מוצגים, {hiddenCount} אוואטארים מוסתרים',
        backButton: 'חזרה',
        popupBodyAriaLabel: 'עם {count} פריטים'
    },
    coreBreadcrumb: {
    ...
    coreSplitter: {
        paginationItemAriaLabel: 'מקטע'
    },
    coreStepInput: {
        ariaRoleDescription: 'קלט שלב',
        decrementButtonTitle: 'ירידה',
        incrementButtonTitle: 'מרווח'
    },
    coreSwitch: {
        semanticAcceptLabel: 'קבל',
