...
export default {
    ...
    platformTable: {
        ...
        deselectSingleRowTitle: 'לחץ לביטול בחירה',
        selectSingleRowTitle: 'לחץ לבחירה'
    },
    platformThumbnail: {
        detailsGotoPreviousButtonTitle: 'עבור לקודם',
        detailsGotoNextButtonTitle: 'עבור לבא',
        detailsDialogCloseBtnLabel: 'סגור',
        roleDescription: 'תמונה'
    },
    platformUploadCollection: {
        moveToTitle: 'העבר אל',
        moveToTitleFolder: 'תיקייה',
        moveToNewFolderBtnLabel: 'תיקייה חדשה',
        moveToAllFilesSubHeaderLabel: 'כל הקבצים',
        moveToConfirmBtn: 'העבר',
        moveToCloseBtn: 'בטל',
        newFolderTitle: 'תיקייה חדשה',
        newFolderAtRootInputLabel: 'שם תיקייה חדשה',
        newFolderAtFolderInputLabel: 'שם התיקייה החדשה בתוך {folderName}',
        newFolderInputPlaceholder: 'הקלד כאן...',
        newFolderInputErrorLabel: 'מקסימום {count} תווים מותרים',
        newFolderDialogCreateBtnLabel: 'צור',
        newFolderDialogCancelBtnLabel: 'בטל',
        breadcrumbLabelAllFiles: 'כל הקבצים',
        breadcrumbLabelAllFilesWithTotal: 'כל הקבצים ({total})',
        searchPlaceholder: 'חפש',
        addBtnLabel: 'הוסף',
        newFolderBtnLabel: 'תיקייה חדשה',
        moveToBtnLabel: 'העבר אל',
        downloadBtnLabel: 'הורד',
        updateVersionBtnLabel: 'עדכן גרסה',
        removeBtnLabel: 'הסר',
        folderIconTitle: 'סמל תיקייה',
        fileIconTitle: 'סמל קובץ',
        editFileNameInputPlaceholder: 'הזן שם',
        editFileNameFileAlreadyExistsError: 'קובץ בשם זה כבר קיים',
        editFileNameFolderAlreadyExistsError: 'תיקייה בשם זה כבר קיימת',
        itemStatusSuccessful: 'הצליח',
        itemStatusUnsuccessful: 'לא הצליח',
        uploadNewFileAfterFailAction: 'הפעל',
        cancelUploadNewFileAction: 'בטל',
        itemMenuBtnTitle: 'עוד',
        dragDropAreaText: 'גרור קבצים להעלאה',
        noDataText: 'לא נמצאו קבצים',
        noDataDescription: 'שחרר קבצים להעלאה, או השתמש בלחצן "הוסף".',
        paginationTotal: 'מציג {from}-{to} מתוך {total}',
        resultsPerPage: 'תוצאות לכל עמוד',
        messageCreateFailed: 'יצירת {folderName} נכשלה.',
        messageCreateSuccess: '{folderName} נוצרה.',
        messageUpdateVersionFailed: 'עדכון הגרסה של {folderName} נכשל.',
        messageUpdateVersionSuccess: 'גרסת {folderName} עודכנה.',
        messageFileRenameFailed: 'נכשל שינוי השם של "{from}" ל-"{to}."',
        messageFileRenameSuccess: 'השם של "{from}" שונה ל-"{to}".',
        messageRemoveFoldersAndFilesFailed: 'הסרת {foldersCount} תיקיות ו-{filesCount} קבצים נכשלה.',
        messageRemoveFoldersAndFilesSuccess: '{foldersCount} תיקיות ו-{filesCount} קבצים הוסרו.',
        messageRemoveFoldersFailed: 'הסרת {foldersCount} תיקיות נכשלה.',
        messageRemoveFoldersSuccess: '{foldersCount} תיקיות הוסרו.',
        messageRemoveFilesFailed: 'הסרת {filesCount} קבצים נכשלה.',
        messageRemoveFilesSuccess: '{filesCount} קבצים הוסרו.',
        messageRemoveFileOrFolderFailed: 'הסרת {name} נכשלה.',
        messageRemoveFileOrFolderSuccess: '{name} הוסר.',
        messageMoveFoldersAndFilesFailed: 'העברת {foldersCount} תיקיות ו-{filesCount} קבצים נכשלה אל {to}.',
        messageMoveFoldersAndFilesSuccess: '{foldersCount} תיקיות ו-{filesCount} קבצים הועברו אל {to}.',
        messageMoveFoldersFailed: 'העברת {foldersCount} תיקיות אל {to} נכשלה.',
        messageMoveFoldersSuccess: '{foldersCount} תיקיות הועברו אל {to}.',
        messageMoveFilesFailed: 'העברת {filesCount} קבצים אל {to} נכשלה.',
        messageMoveFilesSuccess: '{filesCount} קבצים הועברו אל {to}.',
        messageMoveFileOrFolderFailed: 'העברת {name} אל {to} נכשלה.',
        messageMoveFileOrFolderSuccess: '{name} הועבר אל {to}.',
        messageMoveRootFoldersAndFilesFailed: 'העברת {foldersCount} תיקיות ו-{filesCount} קבצים נכשלה לכל הקבצים.',
        messageMoveRootFoldersAndFilesSuccess: '{foldersCount} תיקיות ו-{filesCount} קבצים הועברו לכל הקבצים.',
        messageMoveRootFoldersFailed: 'העברת {foldersCount} תיקיות נכשלה לכל הקבצים.',
        messageMoveRootFoldersSuccess: '{foldersCount} תיקיות הועברו לכל הקבצים.',
        messageMoveRootFilesFailed: 'העברת {filesCount} קבצים לכל הקבצים נכשלה.',
        messageMoveRootFilesSuccess: '{filesCount} קבצים הועברו לכל הקבצים.',
        messageMoveRootFileOrFolderFailed: 'העברת {name} לכל הקבצים נכשלה.',
        messageMoveRootFileOrFolderSuccess: '{name} הועבר לכל הקבצים.',
        messageFileTypeMismatchPlural: 'ל-{filesCount} קבצים יש סוג שגוי. סוגים מותרים: {allowedTypes}.',
        messageFileTypeMismatchSingular: 'לקובץ "{fileName}" יש סוג שגוי. סוגים מותרים: {allowedTypes}.',
        messageFileSizeExceededPlural:
            '{filesCount} קבצים חרגו מגודל הקובץ המרבי. גודל קובץ מקסימלי מותר: {maxFileSize}.',
        messageFileSizeExceededSingular:
            'הקובץ "{fileName}" חרג מגודל הקובץ המרבי. גודל קובץ מקסימלי מותר: {maxFileSize}.',
        messageFileNameLengthExceededPlural:
            '{filesCount} קבצים חרגו מהאורך המקסימלי של שם הקובץ. אורך שם קובץ מותר: {maxFilenameLength} תווים.',
        messageFileNameLengthExceededSingular:
            'השם "{fileName}" חרג מהאורך המקסימלי של שם הקובץ. אורך שם קובץ מותר: {maxFilenameLength} תווים.'
    },
