/* eslint-disable */
// Do not modify, it's automatically created. Modify translations_sq-AL.properties instead
export default {
    coreCalendar: {
    ...
    platformTable: {
        ...
        P13FilterDialogAddFilterBtnTitle: 'Shto filtrin',
    ...
    btpSearchField: {
        ...
        searchInputPlaceholder: 'Kërko',
        searchInputAriaLabel: 'Kërko'
    },
    btpToolHeader: {
