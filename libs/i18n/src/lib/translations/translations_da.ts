...
export default {
    ...
    coreMultiInput: {
        ...
        tokensCountText: 'Indeholder {længde, flertal, =0 {intet token} =1 {1 token} øvrige {# tokens} }.'
    },
    coreNavigation: {
    ...
    platformTable: {
        ...
        deselectSingleRowTitle: 'Klik for at slette markering',
        selectSingleRowTitle: 'Klik for at vælge'
    },
    platformThumbnail: {
        detailsGotoPreviousButtonTitle: 'Gå til forrige',
        detailsGotoNextButtonTitle: 'Gå til næste',
        detailsDialogCloseBtnLabel: 'Luk',
        roleDescription: 'Billede'
    },
    platformUploadCollection: {
        moveToTitle: 'Flyt til',
        moveToTitleFolder: 'Mappe',
        moveToNewFolderBtnLabel: 'Ny mappe',
        moveToAllFilesSubHeaderLabel: 'Alle filer',
        moveToConfirmBtn: 'Flyt',
        moveToCloseBtn: 'Annuller',
        newFolderTitle: 'Ny mappe',
        newFolderAtRootInputLabel: 'Navn på ny mappe',
        newFolderAtFolderInputLabel: 'Navn på ny mappe inden i {folderName}',
        newFolderInputPlaceholder: 'Skriv her...',
        newFolderInputErrorLabel: 'Maks. {count} tilladte tegn',
        newFolderDialogCreateBtnLabel: 'Opret',
        newFolderDialogCancelBtnLabel: 'Annuller',
        breadcrumbLabelAllFiles: 'Alle filer',
        breadcrumbLabelAllFilesWithTotal: 'Alle filer ({total})',
        searchPlaceholder: 'Søg',
        addBtnLabel: 'Tilføj',
        newFolderBtnLabel: 'Ny mappe',
        moveToBtnLabel: 'Flyt til',
        downloadBtnLabel: 'Download',
        updateVersionBtnLabel: 'Opdater version',
        removeBtnLabel: 'Fjern',
        folderIconTitle: 'Mappeikon',
        fileIconTitle: 'Filikon',
        editFileNameInputPlaceholder: 'Angiv et navn',
        editFileNameFileAlreadyExistsError: 'En fil med dette navn findes allerede',
        editFileNameFolderAlreadyExistsError: 'En mappe med dette navn findes allerede',
        itemStatusSuccessful: 'Gennemført',
        itemStatusUnsuccessful: 'Ikke fuldført',
        uploadNewFileAfterFailAction: 'Kør',
        cancelUploadNewFileAction: 'Annuller',
        itemMenuBtnTitle: 'Mere',
        dragDropAreaText: 'Træk filer for at uploade',
        noDataText: 'Der blev ikke fundet nogen filer',
        noDataDescription: 'Slip filer for at uploade, eller brug knappen "Tilføj".',
        paginationTotal: 'Viser {from}-{to} af {total}',
        resultsPerPage: 'Resultater pr. side',
        messageCreateFailed: 'Kunne ikke oprette {folderName}.',
        messageCreateSuccess: '{folderName} er oprettet.',
        messageUpdateVersionFailed: 'Kunne ikke opdatere version af {folderName}.',
        messageUpdateVersionSuccess: 'Version af {folderName} er opdateret.',
        messageFileRenameFailed: 'Kunne ikke omdøbe "{from}" til "{to}."',
        messageFileRenameSuccess: '"{from}" er omdøbt til "{to}".',
        messageRemoveFoldersAndFilesFailed: 'Kunne ikke fjerne {foldersCount} mapper og {filesCount} filer.',
        messageRemoveFoldersAndFilesSuccess: '{foldersCount} mapper og {filesCount} filer er fjernet.',
        messageRemoveFoldersFailed: 'Kunne ikke fjerne {foldersCount} mapper.',
        messageRemoveFoldersSuccess: '{foldersCount} mapper er fjernet.',
        messageRemoveFilesFailed: 'Kunne ikke fjerne {filesCount} filer.',
        messageRemoveFilesSuccess: '{filesCount} filer er fjernet.',
        messageRemoveFileOrFolderFailed: 'Kunne ikke fjerne {name}.',
        messageRemoveFileOrFolderSuccess: '{name} er fjernet.',
        messageMoveFoldersAndFilesFailed: 'Kunne ikke flytte {foldersCount} mapper og {filesCount} filer til {to}.',
        messageMoveFoldersAndFilesSuccess: '{foldersCount} mapper og {filesCount} filer er flyttet til {to}.',
        messageMoveFoldersFailed: 'Kunne ikke flytte {foldersCount} mapper til {to}.',
        messageMoveFoldersSuccess: '{foldersCount} mapper er flyttet til {to}.',
        messageMoveFilesFailed: 'Kunne ikke flytte {filesCount} filer til {to}.',
        messageMoveFilesSuccess: '{filesCount} filer er flyttet til {to}.',
        messageMoveFileOrFolderFailed: 'Kunne ikke flytte {name} til {to}.',
        messageMoveFileOrFolderSuccess: '{name} er flyttet til {to}.',
        messageMoveRootFoldersAndFilesFailed:
            'Kunne ikke flytte {foldersCount} mapper og {filesCount} filer til alle filer.',
        messageMoveRootFoldersAndFilesSuccess: '{foldersCount} mapper og {filesCount} filer er flyttet til alle filer.',
        messageMoveRootFoldersFailed: 'Kunne ikke flytte {foldersCount} mapper til alle filer.',
        messageMoveRootFoldersSuccess: '{foldersCount} mapper er flyttet til alle filer.',
        messageMoveRootFilesFailed: 'Kunne ikke flytte {filesCount} filer til alle filer.',
        messageMoveRootFilesSuccess: '{filesCount} filer er flyttet til alle filer.',
        messageMoveRootFileOrFolderFailed: 'Kunne ikke flytte {name} til alle filer.',
        messageMoveRootFileOrFolderSuccess: '{name} er flyttet til alle filer.',
        messageFileTypeMismatchPlural: '{filesCount} filer har den forkerte type. Tilladte typer: {allowedTypes}.',
        messageFileTypeMismatchSingular: 'Filen "{fileName}" har den forkerte type. Tilladte typer: {allowedTypes}.',
        messageFileSizeExceededPlural:
            '{filesCount} filer overskred den maksimale filstørrelse. Tilladte maksimale filstørrelse: {maxFileSize}.',
        messageFileSizeExceededSingular:
            'Filen "{fileName}" overskred den maksimale filstørrelse. Tilladte maksimale filstørrelse: {maxFileSize}.',
        messageFileNameLengthExceededPlural:
            '{filesCount} filer overskred den maksimale længde for filnavnet. Tilladt længde for filnavnet: {maxFilenameLength} tegn.',
        messageFileNameLengthExceededSingular:
            'Navnet "{fileName}" overskred den maksimale længde for filnavnet. Tilladt længde for filnavnet: {maxFilenameLength} tegn.'
    },
