...
export default {
    btpNavigation: {
        expanderAriaLabel: 'udvid/skjul underelementer',
        moreButtonAriaLabel: 'Viser yderligere navigationselementer, der er skjult pga. begrænset skærmplads',
        overflowMenuAriaLabel: 'Yderligere navigationselementer',
        snappedPopoverRoleDescription: 'Navigationslistetræ'
    },
    btpSearchField: {
    ...
    coreCalendar: {
        ...
        nonWorkDayLabel: 'Arbejdsfri dag',
    ...
    coreMessageStrip: {
        ...
        closable: 'Kan lukkes',
        defaultDismissButtonText: 'Luk',
        defaultHiddenText: 'Meddelelseslinje',
        dismissLabel: 'Luk'
    },
    coreMultiComboBox: {
    ...
    coreSplitter: {
        paginationItemAriaLabel: 'Afsnit'
    },
    coreStepInput: {
    ...
    coreSwitch: {
        semanticAcceptLabel: 'Acceptér',
        semanticDeclineLabel: 'Afvis'
    },
    coreTabs: {
        expandIconLabel: 'Se flere',
    ...
    platformObjectListItem: {
        deleteActionAriaLabel: 'slet',
        detailsActionAriaLabel: 'detalje'
    },
    platformSearchField: {
        allButtonLabel: 'Alle',
        ...
        selectScopeLabel: 'Vælg omfang:',
        selectStateMessageLabel: 'Vælg',
        submitButtonTitle: 'Søg (Enter)',
