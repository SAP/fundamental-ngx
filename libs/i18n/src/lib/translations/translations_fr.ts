...
export default {
    ...
    platformTable: {
        ...
        deselectSingleRowTitle: 'Cliquer pour désélectionner',
        selectSingleRowTitle: 'Cliquer pour sélectionner'
    },
    platformThumbnail: {
        detailsGotoPreviousButtonTitle: 'Revenir au précédent',
        detailsGotoNextButtonTitle: 'Passer au suivant',
    ...
    platformUploadCollection: {
        ...
        newFolderInputPlaceholder: 'Saisissez du texte ici...',
        newFolderInputErrorLabel: '{count} caractères autorisés au maximum',
        ...
        updateVersionBtnLabel: 'Mettre à jour la version',
        removeBtnLabel: 'Supprimer',
        folderIconTitle: 'Icône de dossier',
        fileIconTitle: 'Icône de fichier',
        editFileNameInputPlaceholder: 'Saisir un nom',
        editFileNameFileAlreadyExistsError: 'Un fichier portant ce nom existe déjà.',
        editFileNameFolderAlreadyExistsError: 'Un dossier portant ce nom existe déjà.',
        itemStatusSuccessful: 'Réussite',
        itemStatusUnsuccessful: 'Échec',
        uploadNewFileAfterFailAction: 'Exécuter',
        cancelUploadNewFileAction: 'Annuler',
        itemMenuBtnTitle: 'Plus',
        dragDropAreaText: 'Faire glisser les fichiers pour les télécharger sur le serveur',
        noDataText: 'Aucun fichier trouvé',
        noDataDescription: 'Déposez les fichiers à télécharger sur le serveur ou utilisez le bouton "Ajouter".',
        paginationTotal: 'Affichage {from}-{to} sur {total}',
        resultsPerPage: 'Résultats par page',
        messageCreateFailed: 'Échec de la création de {folderName}',
        messageCreateSuccess: '{folderName} a été créé.',
        messageUpdateVersionFailed: 'Échec de la mise à jour de la version de {folderName}',
        messageUpdateVersionSuccess: 'Version de {folderName} mise à jour',
        messageFileRenameFailed: 'Le changement de nom de "{from}" en "{to}" a échoué.',
        messageFileRenameSuccess: 'Le nom "{from}" a été modifié en "{to}".',
        messageRemoveFoldersAndFilesFailed:
            'Échec de la suppression de {foldersCount} dossiers et de {filesCount} fichiers',
        messageRemoveFoldersAndFilesSuccess: '{foldersCount} dossiers et {filesCount} fichiers ont été supprimés.',
        messageRemoveFoldersFailed: 'Échec de la suppression de {foldersCount} dossiers',
        messageRemoveFoldersSuccess: '{foldersCount} dossiers ont été supprimés.',
        messageRemoveFilesFailed: 'Échec de la suppression de {filesCount} fichiers',
        messageRemoveFilesSuccess: '{filesCount} fichiers ont été supprimés.',
        ...
        messageMoveFoldersAndFilesFailed:
            'Échec du déplacement de {foldersCount} dossiers et de {filesCount} fichiers vers {to}',
        ...
        messageMoveRootFoldersAndFilesFailed:
            'Échec du déplacement de {foldersCount} dossiers et de {filesCount} fichiers vers tous les fichiers',
        ...
        messageMoveRootFoldersFailed: 'Échec du déplacement de {foldersCount} dossiers vers tous les fichiers',
        messageMoveRootFoldersSuccess: '{foldersCount} dossiers ont été déplacés vers tous les fichiers',
        messageMoveRootFilesFailed: 'Échec du déplacement de {filesCount} fichiers vers tous les fichiers',
        messageMoveRootFilesSuccess: '{filesCount} fichiers ont été déplacés vers tous les fichiers.',
        messageMoveRootFileOrFolderFailed: 'Échec du déplacement de {name} vers tous les fichiers',
        messageMoveRootFileOrFolderSuccess: '{name} a été déplacé vers tous les fichiers',
        messageFileTypeMismatchPlural: '{filesCount} fichiers ont le mauvais type. Types autorisés : {allowedTypes}.',
        messageFileTypeMismatchSingular: 'Le fichier "{fileName}" a le mauvais type. Types autorisés : {allowedTypes}.',
        messageFileSizeExceededPlural:
            '{filesCount} fichiers dépassaient la taille de fichier maximale. Taille de fichier maximale autorisée : {maxFileSize}.',
        messageFileSizeExceededSingular:
            'Le fichier "{fileName}" dépassait la taille de fichier maximale. Taille de fichier maximale autorisée : {maxFileSize}.',
        messageFileNameLengthExceededPlural:
            '{filesCount} fichiers dépassaient la longueur maximale de nom de fichier. Longueur de nom de fichier autorisée : {maxFilenameLength} caractères.',
        messageFileNameLengthExceededSingular:
            'Le nom "{fileName}" dépassait la longueur maximale de nom de fichier. Longueur de nom de fichier autorisée : {maxFilenameLength} caractères.'
    },
