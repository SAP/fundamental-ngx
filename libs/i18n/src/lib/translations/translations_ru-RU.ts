/* eslint-disable */
// Do not modify, it's automatically created. Modify translations_ru-RU.properties instead
export default {
    coreCalendar: {
    ...
    coreMultiInput: {
        ...
        tokensCountText:
            '{ length, plural, =0 {Нет выбранных} one {Выбран 1} other {Выбрано #} } { length, plural, one { вариант } few { варианта } other { вариантов } }.'
    },
    coreNavigation: {
