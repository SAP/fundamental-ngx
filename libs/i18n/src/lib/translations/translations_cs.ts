...
export default {
    ...
    platformTable: {
        ...
        deselectSingleRowTitle: 'Kliknutím zrušíte výběr',
        selectSingleRowTitle: 'Kliknutím vyberte'
    },
    platformThumbnail: {
        detailsGotoPreviousButtonTitle: 'Přejít na předchozí',
        detailsGotoNextButtonTitle: 'Přejít na další',
        detailsDialogCloseBtnLabel: 'Zavřít',
        roleDescription: 'Obrázek'
    },
    platformUploadCollection: {
        ...
        newFolderAtFolderInputLabel: 'Název nové složky uvnitř složky {folderName}',
        newFolderInputPlaceholder: 'Zde zadejte...',
        ...
        itemStatusSuccessful: 'Úspěšné',
        itemStatusUnsuccessful: 'Neúspěšné',
        uploadNewFileAfterFailAction: 'Spustit',
        cancelUploadNewFileAction: 'Zrušit',
        itemMenuBtnTitle: 'Více',
        dragDropAreaText: 'Přetažením uploadujte soubory',
        noDataText: 'Nebyly nalezeny žádné soubory',
        noDataDescription: 'Přetáhněte soubory k uploadu nebo použijte tlačítko „Přidat.',
        paginationTotal: 'Zobrazeno: {from}-{to} z {total}',
        resultsPerPage: 'Výsledků na stránku',
        messageCreateFailed: 'Složku {folderName} se nepodařilo vytvořit.',
        messageCreateSuccess: 'Složka {folderName} byla vytvořena.',
        messageUpdateVersionFailed: 'Nepodařilo se aktualizovat verzi složky {folderName}.',
        messageUpdateVersionSuccess: 'Verze složky {folderName} byla aktualizována.',
        messageFileRenameFailed: 'Přejmenování z „{from}“ na „{to}“ se nezdařilo.',
        messageFileRenameSuccess: 'Soubor „{from}“ byl přejmenován na „{to}“.',
        messageRemoveFoldersAndFilesFailed:
            'Nepodařilo se odebrat složky (celkem {foldersCount}) a soubory (celkem {filesCount}).',
        messageRemoveFoldersAndFilesSuccess:
            'Byly odebrány složky (celkem {foldersCount}) a soubory (celkem {filesCount}).',
        messageRemoveFoldersFailed: 'Nepodařilo se odebrat složky (celkem {foldersCount}).',
        messageRemoveFoldersSuccess: 'Byly odebrány složky (celkem {foldersCount}).',
        messageRemoveFilesFailed: 'Nepodařilo se odebrat soubory (celkem {filesCount}).',
        messageRemoveFilesSuccess: 'Byly odebrány soubory (celkem {filesCount}).',
        messageRemoveFileOrFolderFailed: 'Nepodařilo se odebrat složku {name}.',
        messageRemoveFileOrFolderSuccess: 'Složka {name} byla odebrána.',
        messageMoveFoldersAndFilesFailed:
            'Složky (celkem {foldersCount}) a soubory (celkem {filesCount}) se nepodařilo přesunout do {to}.',
        messageMoveFoldersAndFilesSuccess:
            'Složky (celkem {foldersCount}) a soubory (celkem {filesCount}) byly přesunuty do {to}.',
        messageMoveFoldersFailed: 'Složky (celkem {foldersCount}) se nepodařilo přesunout do {to}.',
        messageMoveFoldersSuccess: 'Složky (celkem {foldersCount}) byly přesunuty do {to}.',
        messageMoveFilesFailed: 'Soubory (celkem {filesCount}) se nepodařilo přesunout do {to}.',
        messageMoveFilesSuccess: 'Soubory (celkem {filesCount}) byly přesunuty do {to}.',
        messageMoveFileOrFolderFailed: 'Soubor {name} se nepodařilo přesunout do {to}.',
        messageMoveFileOrFolderSuccess: 'Složka {name} byla přesunuta do {to}.',
        messageMoveRootFoldersAndFilesFailed:
            'Složky (celkem {foldersCount}) a soubory (celkem {filesCount}) se nepodařilo přesunout do všech souborů.',
        messageMoveRootFoldersAndFilesSuccess:
            'Složky (celkem {foldersCount}) a soubory (celkem {filesCount}) byly přesunuty do všech souborů.',
        messageMoveRootFoldersFailed: 'Složky (celkem {foldersCount}) se nepodařilo přesunout do všech souborů.',
        messageMoveRootFoldersSuccess: 'Složky (celkem {foldersCount}) byly přesunuty do všech souborů.',
        messageMoveRootFilesFailed: 'Nepodařilo se přesunout soubory (celkem {filesCount}) do všech souborů.',
        messageMoveRootFilesSuccess: 'Soubory (celkem {filesCount}) byly přesunuty do všech souborů.',
        messageMoveRootFileOrFolderFailed: 'Složku {name} se nepodařilo přesunout do všech souborů.',
        messageMoveRootFileOrFolderSuccess: 'Složka {name} byla přesunuta do všech souborů.',
        messageFileTypeMismatchPlural: 'Soubory (celkem {filesCount}) mají chybný typ. Povolené typy: {allowedTypes}.',
        messageFileTypeMismatchSingular: 'Soubor „{fileName}“ má chybný typ. Povolené typy: {allowedTypes}.',
        messageFileSizeExceededPlural:
            'Soubory (celkem {filesCount}) jsou větší než maximální povolená velikost souboru. Povolená maximální velikost souboru: {maxFileSize}.',
        messageFileSizeExceededSingular:
            'Soubor „{fileName}“ je větší než maximální povolená velikost souboru. Povolená maximální velikost souboru: {maxFileSize}.',
        messageFileNameLengthExceededPlural:
            'Soubory (celkem {filesCount}) mají název delší, než je povolená maximální délka názvu souboru. Povolená maximální znaková délka názvu souboru: {maxFilenameLength}.',
        messageFileNameLengthExceededSingular:
            'Název souboru „{fileName}“ je delší, než je povolená maximální délka názvu souboru. Povolená maximální znaková délka názvu souboru: {maxFilenameLength}.'
    },
