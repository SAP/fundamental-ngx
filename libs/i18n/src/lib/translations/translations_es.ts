...
export default {
    btpNavigation: {
        expanderAriaLabel: 'desplegar/ocultar subposiciones',
        moreButtonAriaLabel:
            'Muestra elementos de navegación adicionales que están ocultos por el espacio limitado de la pantalla',
        overflowMenuAriaLabel: 'Elementos de navegación adicionales',
        snappedPopoverRoleDescription: 'Árbol de la lista de navegación'
    },
    btpSearchField: {
    ...
    coreActionSheet: {
        toolbarLabel: 'Barra de acciones'
    },
    coreAvatarGroup: {
        ariaLabelGroup:
            'Tiene diálogo de tipo de ventana emergente de avatares conjuntos, {count} avatares visualizados, {hiddenCount} avatares ocultos, activar para obtener la lista completa',
        ariaLabelIndividual: 'Avatares individuales. Se muestran {count} avatares, {hiddenCount} avatares ocultos',
        backButton: 'Volver',
        popupBodyAriaLabel: 'Con {count} posiciones'
    },
    coreBreadcrumb: {
    ...
    coreCalendar: {
        ...
        calendarLegendLabel: 'Leyenda de calendario',
        ...
        nonWorkDayLabel: 'Día no laborable',
    ...
    coreMessageStrip: {
        ...
        announcementInfo: 'Línea de mensajes informativos',
        announcementSuccess: 'Línea de mensajes de confirmación',
        announcementWarning: 'Línea de mensajes de advertencia',
        closable: 'Se puede cerrar',
        defaultDismissButtonText: 'Cerrar',
        defaultHiddenText: 'Línea de mensajes',
        dismissLabel: 'Cerrar'
    },
    coreMultiComboBox: {
    ...
    coreSwitch: {
        ...
        semanticDeclineLabel: 'Declinar'
    },
    coreTabs: {
        expandIconLabel: 'Ver más',
    ...
    platformObjectListItem: {
        deleteActionAriaLabel: 'suprimir',
    ...
    platformSearchField: {
        ...
        submitButtonTitle: 'Buscar (Intro)',
        suggestionsWrapperAriaLabel: 'Sugerencias',
    ...
    platformSplitMenuButton: {
        groupLabel: 'Dividir grupo de botones'
    },
    ...
    platformTable: {
        ...
        deselectAllCheckboxLongLabel: 'Casilla de verificación, seleccionadas, hacer clic para deseleccionar todo',
        ...
        P13FilterDialogAddFilterBtnTitle: 'Agregar filtro',
        ...
        selectAllCheckboxMixedLongLabel: 'Casilla de verificación, combinadas, hacer clic para seleccionar todo',
    ...
    platformWizardGenerator: {
        stepsLabel: 'Pasos del asistente',
    ...
    coreFormInputMessageGroup: {
        popoverAriaLabel: 'Mensajes de validación de campo'
    },
