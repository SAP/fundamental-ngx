...
export default {
    ...
    platformTable: {
        ...
        deselectSingleRowTitle: 'Haga clic para anular la selección',
        selectSingleRowTitle: 'Hacer clic para seleccionar'
    },
    platformThumbnail: {
        detailsGotoPreviousButtonTitle: 'Ir a anterior',
        detailsGotoNextButtonTitle: 'Ir a siguiente',
    ...
    platformUploadCollection: {
        ...
        newFolderInputPlaceholder: 'Escribir aquí...',
        ...
        editFileNameInputPlaceholder: 'Escriba un nombre',
        editFileNameFileAlreadyExistsError: 'Ya existe un archivo con este nombre',
        editFileNameFolderAlreadyExistsError: 'Ya existe una carpeta con el nombre',
        itemStatusSuccessful: 'Correcto',
        itemStatusUnsuccessful: 'Incorrecto',
        ...
        noDataText: 'No se han encontrado archivos',
        noDataDescription: 'Coloque archivos para cargarlos o utilice el botón “Añadir”.',
        paginationTotal: 'Mostrando {from}-{to} de {total}',
        resultsPerPage: 'Resultados por página',
        messageCreateFailed: 'Error al crear {folderName}.',
        messageCreateSuccess: 'Se ha creado {folderName}',
        messageUpdateVersionFailed: 'Error al actualizar la versión de {folderName}.',
        messageUpdateVersionSuccess: 'Se ha actualizado la versión de {folderName}',
        messageFileRenameFailed: 'Error al renombrar de "{from}" a "{to}."',
        messageFileRenameSuccess: '"{from}" se ha renombrado a "{to}".',
        messageRemoveFoldersAndFilesFailed: 'Error al eliminar {foldersCount} carpetas y {filesCount} archivos.',
        messageRemoveFoldersAndFilesSuccess: 'Se han eliminado {foldersCount} carpetas y {filesCount} archivos.',
        messageRemoveFoldersFailed: 'Error al eliminar {foldersCount} carpetas.',
        messageRemoveFoldersSuccess: 'Se han eliminado {foldersCount} carpetas.',
        messageRemoveFilesFailed: 'Error al eliminar {filesCount} archivos.',
        messageRemoveFilesSuccess: 'Se han eliminado {filesCount} archivos.',
        messageRemoveFileOrFolderFailed: 'Error al eliminar {name}.',
        messageRemoveFileOrFolderSuccess: 'Se ha eliminado {name}.',
        messageMoveFoldersAndFilesFailed: 'Error al mover {foldersCount} carpetas y {filesCount} archivos a {to}.',
        messageMoveFoldersAndFilesSuccess: 'Se han movido {foldersCount} carpetas y {filesCount} archivos a {to}.',
        messageMoveFoldersFailed: 'Error al mover {foldersCount} carpetas a {to}.',
        messageMoveFoldersSuccess: 'Se han movido {foldersCount} carpetas a {to}.',
        messageMoveFilesFailed: 'Error al mover {filesCount} archivos a {to}',
        messageMoveFilesSuccess: 'Se han movido {filesCount} archivos a {to}.',
        messageMoveFileOrFolderFailed: 'Error al mover {name} a {to}.',
        ...
        messageMoveRootFoldersAndFilesSuccess:
            'Se han movido {foldersCount} carpetas y {filesCount} archivos a todos los archivos.',
        messageMoveRootFoldersFailed: 'Error al mover {foldersCount} carpetas a todos los archivos.',
        messageMoveRootFoldersSuccess: 'Se han movido {foldersCount} carpetas a todos los archivos.',
        messageMoveRootFilesFailed: 'Error al mover {filesCount} archivos a todos los archivos.',
        messageMoveRootFilesSuccess: 'Se han movido {filesCount} archivos a todos los archivos.',
        messageMoveRootFileOrFolderFailed: 'Error al mover {name} a todos los archivos.',
        messageMoveRootFileOrFolderSuccess: '{name} se ha movido a todos los archivos.',
        messageFileTypeMismatchPlural:
            '{filesCount} archivos son de un tipo incorrecto. Tipos permitidos: {allowedTypes}.',
        messageFileTypeMismatchSingular:
            'El archivo "{fileName}" es de un tipo incorrecto. Tipos permitidos: {allowedTypes}.',
        messageFileSizeExceededPlural:
            '{filesCount} archivos han superado el tamaño máximo de archivo. Tamaño máximo de archivo permitido: {maxFileSize}.',
        messageFileSizeExceededSingular:
            '{filesCount} archivos han superado el tamaño máximo de archivo. Tamaño máximo de archivo permitido: {maxFileSize}.',
        messageFileNameLengthExceededPlural:
            '{filesCount} archivos han superado la longitud máxima de nombre de archivo. Longitud de nombre de archivo permitida: {maxFilenameLength} caracteres.',
        messageFileNameLengthExceededSingular:
            'El nombre "{fileName}" ha superado la longitud máxima de nombre de archivo. Longitud de nombre de archivo permitida: {maxFilenameLength} caracteres.'
    },
