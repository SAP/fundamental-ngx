...
export default {
    ...
    coreAvatarGroup: {
        ariaLabelGroup:
            'A caixa de diálogo do tipo de pop-up tem avatares unidos, {count} avatares exibidos, {hiddenCount} avatares ocultos, ativar para lista completa',
        ariaLabelIndividual: 'Avatares individuais. {count}avatares exibidos, {hiddenCount} avatares ocultos',
        backButton: 'Voltar',
        popupBodyAriaLabel: 'Com {count} itens'
    },
    coreBreadcrumb: {
    ...
    coreButton: {
        attentionTypeDescription: 'Aviso',
        emphasizedTypeDescription: 'Ação padrão',
        negativeTypeDescription: 'Ação negativa',
        positiveTypeDescription: 'Ação positiva'
    },
    coreCalendar: {
    ...
    coreObjectIdentifier: {
        srOnlyAriaLabel: 'Identificação de objeto'
    },
    coreObjectMarker: {
        active: 'Status (ativo)',
        inactive: 'Status'
    ...
    coreObjectNumber: {
        critical: 'Status de valor Aviso',
        emphasized: 'Realçado',
        informative: 'Status de valor Informação',
        negative: 'Status de valor Erro',
        positive: 'Status de valor Sucesso'
    },
    coreObjectStatus: {
        ariaLabel: 'Status do objeto',
        ariaRoleDescription: 'Botão do status do objeto',
        critical: 'Aviso emitido',
        indicationColor: 'Cor de indicação',
        informative: 'Entrada informativa',
        negative: 'Entrada inválida',
    ...
    coreProductSwitch: {
        ariaLabel: 'Iniciador de aplicativo',
        targetBlank: 'abre em uma nova aba do navegador',
        targetParent: 'abre no quadro raiz',
        targetTop: 'abre na janela completa do navegador'
    },
    coreRadio: {
        readOnlyDescription: 'Este botão de opção é somente leitura e não pode ser alterado.'
    },
    coreRatingIndicator: {
        ariaLabelReset: 'Redefinir para zero',
        ariaLabelTotalRating: 'Total de avaliações',
        ariaLabelValue: 'de',
    ...
    platformTable: {
        ...
        collapseAllAnnouncementLabel: '"Recolher tudo" clicado',
        ...
        emptyCell: 'Vazio',
        expandAllAnnouncementLabel: '"Expandir tudo" clicado',
        ...
        resetConfirmationAnnouncement: 'Redefinição de valores',
        ...
        sortDialogAddSort: 'Adicionar critério de classificação',
        sortDialogCancelBtnLabel: 'Cancelar',
        sortDialogConfirmBtnLabel: 'OK',
        sortDialogDelete: 'Remover critério de classificação',
        sortDialogHeader: 'Classificar',
        sortDialogMoveUp: 'Mover para cima',
        sortDialogMoveDown: 'Mover para baixo',
