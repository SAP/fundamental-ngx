...
export default {
    ...
    platformTable: {
        ...
        deselectSingleRowTitle: 'Klikk for å oppheve merkingen',
        selectSingleRowTitle: 'Klikk for å merke'
    },
    platformThumbnail: {
        detailsGotoPreviousButtonTitle: 'Gå til forrige',
        detailsGotoNextButtonTitle: 'Gå til neste',
        detailsDialogCloseBtnLabel: 'Lukk',
        roleDescription: 'Bilde'
    },
    platformUploadCollection: {
        moveToTitle: 'Flytt til',
        moveToTitleFolder: 'Mappe',
        moveToNewFolderBtnLabel: 'Ny mappe',
        moveToAllFilesSubHeaderLabel: 'Alle filer',
        moveToConfirmBtn: 'Flytt',
        moveToCloseBtn: 'Avbryt',
        newFolderTitle: 'Ny mappe',
        newFolderAtRootInputLabel: 'Navn på ny mappe',
        newFolderAtFolderInputLabel: 'Navn på ny mappe i {folderName}',
        newFolderInputPlaceholder: 'Skriv her ...',
        newFolderInputErrorLabel: 'Maks. {count} tegn er tillatt',
        newFolderDialogCreateBtnLabel: 'Opprett',
        newFolderDialogCancelBtnLabel: 'Avbryt',
        breadcrumbLabelAllFiles: 'Alle filer',
        breadcrumbLabelAllFilesWithTotal: 'Alle filer ({total})',
        searchPlaceholder: 'Søk',
        addBtnLabel: 'Legg til',
        newFolderBtnLabel: 'Ny mappe',
        moveToBtnLabel: 'Flytt til',
        downloadBtnLabel: 'Last ned',
        updateVersionBtnLabel: 'Oppdater versjon',
        removeBtnLabel: 'Fjern',
        folderIconTitle: 'Mappeikon',
        fileIconTitle: 'Filikon',
        editFileNameInputPlaceholder: 'Angi et navn',
        editFileNameFileAlreadyExistsError: 'Det finnes allerede en fil med dette navnet',
        editFileNameFolderAlreadyExistsError: 'Det finnes allerede en mappe med dette navnet',
        itemStatusSuccessful: 'Utført',
        itemStatusUnsuccessful: 'Mislykket',
        uploadNewFileAfterFailAction: 'Kjør',
        cancelUploadNewFileAction: 'Avbryt',
        itemMenuBtnTitle: 'Mer',
        dragDropAreaText: 'Dra filer for å laste opp',
        noDataText: 'Finner ingen filer',
        noDataDescription: 'Slipp filer for opplasting, eller bruk knappen "Legg til".',
        paginationTotal: 'Viser {from}-{to} av {total}',
        resultsPerPage: 'Resultater per side',
        messageCreateFailed: 'Kan ikke opprette {folderName}.',
        messageCreateSuccess: '{folderName} er opprettet.',
        messageUpdateVersionFailed: 'Kan ikke oppdatere versjon av {folderName}.',
        messageUpdateVersionSuccess: '{folderName}-versjon er oppdatert.',
        messageFileRenameFailed: 'Endring av navn "{from}" til "{to}" mislyktes.',
        messageFileRenameSuccess: '"{from}" har endret navn til "{to}".',
        messageRemoveFoldersAndFilesFailed: 'Fjerning av {foldersCount} mapper og {filesCount} filer mislyktes.',
        messageRemoveFoldersAndFilesSuccess: '{foldersCount} mapper og {filesCount} filer er fjernet.',
        messageRemoveFoldersFailed: 'Fjerning av {foldersCount} mapper mislyktes.',
        messageRemoveFoldersSuccess: '{foldersCount} mapper er fjernet.',
        messageRemoveFilesFailed: 'Fjerning av {filesCount} filer mislyktes.',
        messageRemoveFilesSuccess: '{filesCount} filer er fjernet.',
        messageRemoveFileOrFolderFailed: 'Fjerning av {name} mislyktes.',
        messageRemoveFileOrFolderSuccess: '{name} er fjernet.',
        messageMoveFoldersAndFilesFailed: 'Flytting av {foldersCount} mapper og {filesCount} filer til {to} mislyktes.',
        messageMoveFoldersAndFilesSuccess: '{foldersCount} mapper og {filesCount} filer er flyttet til {to}.',
        messageMoveFoldersFailed: 'Flytting av {foldersCount} mapper til {to} mislyktes.',
        messageMoveFoldersSuccess: '{foldersCount} mapper er flyttet til {to}.',
        messageMoveFilesFailed: 'Fjerning av {filesCount} filer til {to}.',
        messageMoveFilesSuccess: '{filesCount} filer er flyttet til {to}.',
        messageMoveFileOrFolderFailed: 'Flytting av {name} til {to} mislyktes.',
        messageMoveFileOrFolderSuccess: '{name} er flyttet til {to}.',
        messageMoveRootFoldersAndFilesFailed:
            'Flytting av {foldersCount} mapper og {filesCount} filer til alle filer mislyktes.',
        messageMoveRootFoldersAndFilesSuccess: '{foldersCount} mapper og {filesCount} filer er flyttet til alle filer.',
        messageMoveRootFoldersFailed: 'Flytting av {foldersCount} mapper til alle filer mislyktes.',
        messageMoveRootFoldersSuccess: '{foldersCount} mapper er flyttet til alle filer.',
        messageMoveRootFilesFailed: 'Flytting av {filesCount} filer til alle filer.',
        messageMoveRootFilesSuccess: '{filesCount} filer er flyttet til alle filer.',
        messageMoveRootFileOrFolderFailed: 'Flytting av {name} til alle filer mislyktes.',
        messageMoveRootFileOrFolderSuccess: '{name} er flyttet til alle filer.',
        messageFileTypeMismatchPlural: '{filesCount} filer har feil type. Tillatte typer: {allowedTypes}.',
        messageFileTypeMismatchSingular: 'Filen "{fileName}" har feil type. Tillatte typer: {allowedTypes}.',
        messageFileSizeExceededPlural:
            '{filesCount} filer overskrider den maksimale filstørrelsen. Tillatt maksimal filstørrelse: {maxFileSize}.',
        messageFileSizeExceededSingular:
            'Filen "{fileName}" overskrider den maksimale filstørrelsen. Tillatt maksimal filstørrelse: {maxFileSize}.',
        messageFileNameLengthExceededPlural:
            '{filesCount} filer overskrider den maksimale lengden for filnavn. Tillatt lengde for filnavn: {maxFilenameLength} tegn.',
        messageFileNameLengthExceededSingular:
            'Navnet "{fileName}" overskrider den maksimale lengden for filnavn. Tillatt lengde for filnavn: {maxFilenameLength} tegn.'
    },
