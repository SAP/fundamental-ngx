...
export default {
    btpNavigation: {
        ...
        snappedPopoverRoleDescription: 'Stablo popisa navigacije'
    },
    btpSearchField: {
        clearButtonLabel: 'Poništi',
    ...
    coreActionSheet: {
        toolbarLabel: 'Traka radnji'
    },
    coreAvatarGroup: {
        ariaLabelGroup:
            'Ima spojene avatare u dijalogu tipa skočnog prozora, {count} avatara prikazano, {hiddenCount} avatara skriveno, aktivirajte za potpuni popis',
        ariaLabelIndividual: 'Pojedinačni avatari. {count}avatara prikazano, {hiddenCount} avatara skriveno',
        backButton: 'Natrag',
        popupBodyAriaLabel: 'S ovoliko stavki: {count}'
    },
    coreBreadcrumb: {
    ...
    coreCard: {
        ariaDescription: 'Aktivno, pritisnite Enter za aktivaciju',
        roleDescription: 'Kartica {cardType}'
    },
    coreCarousel: {
        leftNavigationBtnLabel: 'Idi na prethodnu stavku',
        pageIndicatorLabel: 'Prikazana je stavka {itemNum} od {totalNum}',
        rightNavigationBtnLabel: 'Idi na sljedeću stavku'
    },
    coreCombobox: {
        clearButtonTitle: 'Očisti unos'
    },
    coreDatePicker: {
    ...
    coreGridList: {
        ...
        listItemCounterAriaLabel: 'Stavka ima ovoliko podređenih elemenata: {count}.',
    ...
    coreMessageStrip: {
        ...
        announcementInfo: 'Traka informativne poruke',
    ...
    coreMultiInput: {
        ...
        tokensCountText: 'Sadržava ukupno ovoliko tokena: {length}'
    },
    coreNavigation: {
    ...
    coreObjectIdentifier: {
        srOnlyAriaLabel: 'Identifikator objekata'
    },
    coreObjectMarker: {
    ...
    coreObjectNumber: {
        critical: 'Status vrijednosti Upozorenje',
        emphasized: 'Naglašeno',
        informative: 'Status vrijednosti Informacije',
        negative: 'Status vrijednosti Pogreška',
        positive: 'Status vrijednosti Uspješno'
    },
    coreObjectStatus: {
        ariaLabel: 'Status objekta',
        ariaRoleDescription: 'Gumb statusa objekta',
        critical: 'Izdano upozorenje',
        indicationColor: 'Boja pokazatelja',
        informative: 'Informativni unos',
        negative: 'Nevaljan unos',
        positive: 'Unos uspješno validiran'
    },
    coreOverflowLayout: {
    ...
    coreRatingIndicator: {
        ...
        ariaLabelTotalRating: 'Ukupno vrednovanje',
        ariaLabelValue: 'od',
    ...
    coreSplitter: {
        paginationItemAriaLabel: 'Odjeljak'
    },
    coreStepInput: {
    ...
    platformApprovalFlow: {
        ...
        nodeMembersCount: 'Članovi: {count}',
        nodeMenuButtonTitle: 'Izbornik',
        nodeStatusDueInXDays: 'Rok za {count} dana',
        nodeStatusDueToday: 'Rok je danas',
        nodeStatusXDaysOverdue: '{count} dana prekoračenje',
    ...
    platformObjectListItem: {
        ...
        detailsActionAriaLabel: 'pojedinost'
    },
    platformSearchField: {
        allButtonLabel: 'Sve',
        cancelLabel: 'Odustani',
        clearButtonTitle: 'Očisti pretraživanje',
        counterLabel: 'Ukupan broj rezultata: {count}',
        deleteButtonAriaLabel: 'Ukloni',
        deleteButtonTitle: 'Ukloni prijedlog',
        groupHeader: 'Zaglavlje grupe',
        searchInputLabel: 'Pretraži',
        searchSuggestionMessage: 'Pronađeno je ovoliko prijedloga: {count}.',
        ...
        submitButtonTitle: 'Traži (Enter)',
        suggestionsWrapperAriaLabel: 'Prijedlozi',
    ...
    platformSplitMenuButton: {
        groupLabel: 'Grupa gumba za podjelu'
    },
    ...
    platformTable: {
        ...
        deselectAllCheckboxLongLabel: 'Potvrdni okvir, označen, klikni za poništenje svih odabira',
        ...
        P13FilterDialogAddFilterBtnTitle: 'Dodaj filtar',
        ...
        selectAllCheckboxMixedLongLabel: 'Potvrdni okvir, mješovito, klikni za odabir svega',
        ...
        toolbarActionButtonTitle: 'Postavke',
    ...
    platformTextarea: {
        counterMessageCharactersOverTheLimitPlural: 'Broj znakova preko ograničenja: {count}',
        counterMessageCharactersOverTheLimitSingular: 'Broj znakova više od ograničenja: 1',
        counterMessageCharactersRemainingPlural: 'Preostalo znakova: {count}',
    ...
    platformVHD: {
        ...
        defineConditionMaxCountError: 'Unesite vrijednost s najviše ovoliko znakova: {count}',
        ...
        selectTabCountHiddenA11yLabel: 'sadržava {rowCount} redova i {colCount} stupaca',
