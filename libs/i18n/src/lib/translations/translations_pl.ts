...
export default {
    ...
    platformTable: {
        ...
        deselectSingleRowTitle: 'Kliknij, aby odznaczyć',
        selectSingleRowTitle: 'Kliknij, aby zaznaczyć'
    },
    platformThumbnail: {
        detailsGotoPreviousButtonTitle: 'Przejdź do poprzedniej',
        detailsGotoNextButtonTitle: 'Przejdź do następnej',
    ...
    platformUploadCollection: {
        ...
        moveToConfirmBtn: 'Przenieś',
        moveToCloseBtn: 'Anuluj',
        newFolderTitle: 'Nowy folder',
        newFolderAtRootInputLabel: 'Nazwa nowego folderu',
        newFolderAtFolderInputLabel: 'Nazwa nowego folderu w {folderName}',
        newFolderInputPlaceholder: 'Wpisz tutaj...',
        newFolderInputErrorLabel: 'Maksymalna liczba dozwolonych znaków: {count}',
        ...
        downloadBtnLabel: 'Pobierz',
        updateVersionBtnLabel: 'Zaktualizuj wersję',
        removeBtnLabel: 'Usuń',
        folderIconTitle: 'Ikona folderu',
        fileIconTitle: 'Ikona pliku',
        editFileNameInputPlaceholder: 'Wprowadź nazwę',
        editFileNameFileAlreadyExistsError: 'Plik o tej nazwie już istnieje',
        editFileNameFolderAlreadyExistsError: 'Folder o tej nazwie już istnieje',
        itemStatusSuccessful: 'Pomyślne',
        itemStatusUnsuccessful: 'Niepomyślne',
        uploadNewFileAfterFailAction: 'Uruchom',
        cancelUploadNewFileAction: 'Anuluj',
        itemMenuBtnTitle: 'Więcej',
        dragDropAreaText: 'Przeciągnij pliki w celu przesłania',
        noDataText: 'Nie znaleziono plików',
        noDataDescription: 'Upuść pliki do przesłania lub użyj przycisku “Dodaj”.',
        paginationTotal: 'Wyświetlanie {from}-{to} z {total}',
        resultsPerPage: 'Wyniki na stronę',
        messageCreateFailed: 'Nie udało się utworzyć {folderName}.',
        messageCreateSuccess: 'Utworzono {folderName}.',
        messageUpdateVersionFailed: 'Nie udało się zaktualizować wersji {folderName}.',
        messageUpdateVersionSuccess: 'Zaktualizowo wersję {folderName}.',
        messageFileRenameFailed: 'Nie udało się zmienić nazwy "{from}" na "{to}."',
        messageFileRenameSuccess: 'Zmieniono nazwę "{from}" na "{to}".',
        messageRemoveFoldersAndFilesFailed:
            'Nie udało się usunąć {foldersCount} folderu(-ów) i {filesCount} pliku(-ów).',
        messageRemoveFoldersAndFilesSuccess: 'Usunięto {foldersCount} foldery(-ów) i {filesCount} pliki(-ów).',
        messageRemoveFoldersFailed: 'Nie udało się usunąć {foldersCount} folderu(-ów).',
        messageRemoveFoldersSuccess: 'Liczba usuniętych folderów: {foldersCount}.',
        messageRemoveFilesFailed: 'Nie udało się usunąć {filesCount} pliku(-ów).',
        messageRemoveFilesSuccess: 'Liczba usuniętych plików: {filesCount}.',
        messageRemoveFileOrFolderFailed: 'Nie udało się usunąć {name}.',
        messageRemoveFileOrFolderSuccess: 'Usunięto {name}.',
        messageMoveFoldersAndFilesFailed:
            'Nie udało się przenieść {foldersCount} folderu(-ów) i {filesCount} pliku(-ów) do {to}.',
        messageMoveFoldersAndFilesSuccess:
            'Przeniesiono {foldersCount} foldery(-ów) i {filesCount} pliki(-ów) do {to}.',
        messageMoveFoldersFailed: 'Nie udało się przenieść {foldersCount} folderu(-ów) do {to}.',
        messageMoveFoldersSuccess: 'Liczba przeniesionych folderów: {foldersCount} do {to}.',
        messageMoveFilesFailed: 'Nie udało się przenieść {filesCount} pliku(-ów) do {to}.',
        messageMoveFilesSuccess: 'Liczba przeniesionych plików: {filesCount} do {to}.',
        messageMoveFileOrFolderFailed: 'Nie udało się przenieść {name} do {to}.',
        messageMoveFileOrFolderSuccess: 'Przeniesiono {name} do {to}.',
        messageMoveRootFoldersAndFilesFailed:
            'Nie udało się przenieść {foldersCount} folderu(-ów) i {filesCount} pliku(-ów) do wszystkich plików.',
        messageMoveRootFoldersAndFilesSuccess:
            'Przeniesiono {foldersCount} foldery(-ów) i {filesCount} pliki(-ów) do wszystkich plików.',
        messageMoveRootFoldersFailed: 'Nie udało się przenieść {foldersCount} folderu(-ów) do wszystkich plików.',
        messageMoveRootFoldersSuccess: 'Liczba przeniesionych folderów: {foldersCount} do wszystkich plików.',
        messageMoveRootFilesFailed: 'Nie udało się przenieść {filesCount} pliki(-ów) do wszystkich plików.',
        messageMoveRootFilesSuccess: 'Liczba przeniesionych plików: {filesCount} do wszystkich plików.',
        messageMoveRootFileOrFolderFailed: 'Nie udało się przenieść {name} do wszystkich plików.',
        messageMoveRootFileOrFolderSuccess: 'Przeniesiono {name} do wszystkich plików.',
        messageFileTypeMismatchPlural: 'Pliki {filesCount} mają nieprawidłowy typ. Dozwolone typy: {allowedTypes}.',
        messageFileTypeMismatchSingular: 'Plik "{fileName}" ma nieprawidłowy typ. Dozwolone typy: {allowedTypes}.',
        messageFileSizeExceededPlural:
            'Liczba plików z przekroczonym rozmiarem pliku: {filesCount}. Maksymalny dozwolony rozmiar pliku: {maxFileSize}.',
        messageFileSizeExceededSingular:
            'Plik "{fileName}" przekroczył maksymalny rozmiar pliku. Maksymalny dozwolony rozmiar pliku: {maxFileSize}.',
        messageFileNameLengthExceededPlural:
            'Liczba plików z przekroczoną maksymalną długością nazwy pliku: {filesCount}. Dozwolona długość nazwy pliku: {maxFilenameLength} znaków.',
        messageFileNameLengthExceededSingular:
            'Nazwa "{fileName}" przekroczyła maksymalną długość nazwy pliku. Dozwolona długość nazwy pliku: {maxFilenameLength} znaków.'
    },
