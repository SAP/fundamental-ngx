...
export default {
    ...
    coreAvatarGroup: {
        ariaLabelGroup:
            "Ha finestra di dialogo di tipo a comparsa avatar congiunti, {count} avatar visualizzati, {hiddenCount} avatar nascosti; attivare per l'elenco completo",
        ariaLabelIndividual: 'Avatar individuali. {count} avatar visualizzati, {hiddenCount} avatar nascosti',
        backButton: 'Indietro',
        popupBodyAriaLabel: 'Con {count} voci'
    },
    coreBreadcrumb: {
    ...
    coreObjectIdentifier: {
        srOnlyAriaLabel: 'Identificativo oggetto'
    },
    coreObjectMarker: {
        active: 'Stato (attivo)',
        inactive: 'Stato'
    ...
    coreObjectNumber: {
        critical: 'Stato valore Avviso',
        emphasized: 'Evidenziato',
        informative: 'Stato valore Informazione',
        negative: 'Stato valore Errore',
        positive: 'Stato valore Operazione completata'
    },
    coreObjectStatus: {
        ariaLabel: 'Stato oggetto',
        ariaRoleDescription: 'Pulsante Stato oggetto',
        critical: 'Avviso generato',
        indicationColor: 'Colore indicazione',
        informative: 'Voce informativa',
        negative: 'Immissione non valida',
    ...
    coreRatingIndicator: {
        ariaLabelReset: 'Reimposta su zero',
        ariaLabelTotalRating: 'Valutazione totale',
        ariaLabelValue: 'di',
    ...
    platformTable: {
        ...
        P13FilterDialogAddFilterBtnTitle: 'Aggiungi filtro',
