...
export default {
    ...
    coreMultiInput: {
        ...
        tokensCountText: 'Contiene {lunghezza, plurale, =0 {no token} =1 {1 token} altri {# tokens} }.'
    },
    coreNavigation: {
    ...
    platformTable: {
        ...
        deselectSingleRowTitle: 'Fai clic per deselezionare',
        selectSingleRowTitle: 'Fai clic per selezionare'
    },
    platformThumbnail: {
        detailsGotoPreviousButtonTitle: 'Vai a precedente',
        detailsGotoNextButtonTitle: 'Vai a successivo',
    ...
    platformUploadCollection: {
        ...
        moveToAllFilesSubHeaderLabel: 'Tutti i file',
        ...
        newFolderAtFolderInputLabel: 'Nome della nuova cartella in {folderName}',
        newFolderInputPlaceholder: 'Digita qui...',
        newFolderInputErrorLabel: 'Sono consentiti massimo {count} caratteri',
        newFolderDialogCreateBtnLabel: 'Crea',
        newFolderDialogCancelBtnLabel: 'Annulla',
        breadcrumbLabelAllFiles: 'Tutti i file',
        breadcrumbLabelAllFilesWithTotal: 'Tutti i file ({total})',
        searchPlaceholder: 'Cerca',
        addBtnLabel: 'Aggiungi',
        newFolderBtnLabel: 'Nuova cartella',
        moveToBtnLabel: 'Sposta in',
        ...
        editFileNameInputPlaceholder: 'Immetti un nome',
        editFileNameFileAlreadyExistsError: 'Esiste già un file con questo nome',
        editFileNameFolderAlreadyExistsError: 'Esiste già una cartella con questo nome',
        itemStatusSuccessful: 'Riuscito',
        itemStatusUnsuccessful: 'Non riuscito',
        uploadNewFileAfterFailAction: 'Esegui',
        cancelUploadNewFileAction: 'Annulla',
        itemMenuBtnTitle: 'Di più',
        dragDropAreaText: 'Trascinare i file per caricarli',
        noDataText: 'Nessun file trovato',
        noDataDescription: 'Rilasciare i file da caricare oppure usare il pulsante “Aggiungi”.',
        paginationTotal: '{from}-{to} di {total} visualizzati',
        resultsPerPage: 'Risultati per pagina',
        messageCreateFailed: 'Impossibile creare {folderName}.',
        messageCreateSuccess: '{folderName} creato.',
        ...
        messageFileRenameSuccess: '"{from}"è stato rinominato "{to}".',
        messageRemoveFoldersAndFilesFailed: 'Impossibile rimuovere {foldersCount} cartelle e {filesCount} file.',
        messageRemoveFoldersAndFilesSuccess: 'Sono stati rimossi {foldersCount} cartelle e {filesCount} file.',
        messageRemoveFoldersFailed: 'Impossibile rimuovere {foldersCount} cartelle.',
        messageRemoveFoldersSuccess: '{foldersCount} cartelle sono state rimosse.',
        messageRemoveFilesFailed: 'Impossibile rimuovere {filesCount} file.',
        messageRemoveFilesSuccess: '{filesCount} file sono stati rimossi.',
        messageRemoveFileOrFolderFailed: 'Impossibile rimuovere {name}.',
        messageRemoveFileOrFolderSuccess: '{name} è stato rimosso.',
        messageMoveFoldersAndFilesFailed: 'Impossibile spostare {foldersCount} cartelle e {filesCount} file in {to}.',
        messageMoveFoldersAndFilesSuccess: '{foldersCount} cartelle e {filesCount} file sono stati spostati in {to}.',
        messageMoveFoldersFailed: 'Impossibile spostare {foldersCount} cartelle in {to}.',
        messageMoveFoldersSuccess: '{foldersCount} cartelle sono state spostate in {to}.',
        messageMoveFilesFailed: 'Impossibile spostare {filesCount} file in {to}.',
        messageMoveFilesSuccess: '{filesCount} file sono stati spostati in {to}.',
        ...
        messageMoveRootFoldersAndFilesFailed:
            'Impossibile spostare {foldersCount} cartelle e {filesCount} file in tutti i file.',
        messageMoveRootFoldersAndFilesSuccess:
            '{foldersCount} cartelle e {filesCount} file sono stati spostati in tutti i file.',
        messageMoveRootFoldersFailed: 'Impossibile spostare {foldersCount} cartelle in tutti i file.',
        messageMoveRootFoldersSuccess: '{foldersCount} cartelle sono state spostate in tutti i file.',
        messageMoveRootFilesFailed: 'Impossibile spostare {filesCount} file in tutti i file.',
        ...
        messageFileTypeMismatchPlural:
            'Il tipo di file di {filesCount} file è errato. Tipi consentiti: {allowedTypes}.',
        messageFileTypeMismatchSingular: 'Il tipo di file di "{fileName}" è errato. Tipi consentiti: {allowedTypes}.',
        messageFileSizeExceededPlural:
            '{filesCount} file superano la dimensione massima. Dimensione file massima consentita: {maxFileSize}.',
        messageFileSizeExceededSingular:
            'Il file "{fileName}" supera la dimensione massima. Dimensione file massima consentita: {maxFileSize}.',
        messageFileNameLengthExceededPlural:
            '{filesCount} file superano la lunghezza massima del nome file. Lunghezza massima consentita per il nome file: {maxFilenameLength} caratteri.',
        messageFileNameLengthExceededSingular:
            'Il nome "{fileName}" supera la lunghezza massima del nome file. Lunghezza massima consentita per il nome file: {maxFilenameLength} caratteri.'
    },
