...
export default {
    ...
    platformTable: {
        ...
        deselectSingleRowTitle: 'Seçimi kaldırmak için tıklayın',
        selectSingleRowTitle: 'Seçmek için tıklayın'
    },
    platformThumbnail: {
    ...
    platformUploadCollection: {
        moveToTitle: 'Taşıma yeri',
        moveToTitleFolder: 'Klasör',
        moveToNewFolderBtnLabel: 'Yeni Klasör',
        moveToAllFilesSubHeaderLabel: 'Tüm dosyalar',
        moveToConfirmBtn: 'Taşı',
        moveToCloseBtn: 'İptal',
        newFolderTitle: 'Yeni klasör',
        newFolderAtRootInputLabel: 'Yeni klasörün adı',
        newFolderAtFolderInputLabel: '{folderName} klasörünün içindeki yeni klasörün adı',
        newFolderInputPlaceholder: 'Buraya yazın...',
        newFolderInputErrorLabel: 'En fazla {count} karakter girilebilir',
        newFolderDialogCreateBtnLabel: 'Oluştur',
        newFolderDialogCancelBtnLabel: 'İptal',
        breadcrumbLabelAllFiles: 'Tüm dosyalar',
        breadcrumbLabelAllFilesWithTotal: 'Tüm dosyalar ({total})',
        searchPlaceholder: 'Ara',
        addBtnLabel: 'Ekle',
        newFolderBtnLabel: 'Yeni Klasör',
        moveToBtnLabel: 'Taşıma yeri',
        downloadBtnLabel: 'Karşıdan Yükle',
        updateVersionBtnLabel: 'Sürümü güncelle',
        removeBtnLabel: 'Kaldır',
        folderIconTitle: 'Klasör simgesi',
        fileIconTitle: 'Dosya simgesi',
        editFileNameInputPlaceholder: 'Ad girin',
        editFileNameFileAlreadyExistsError: 'Bu ada sahip dosya zaten mevcut',
        editFileNameFolderAlreadyExistsError: 'Bu ada sahip klasör zaten mevcut',
        itemStatusSuccessful: 'Başarılı',
        itemStatusUnsuccessful: 'Başarısız',
        uploadNewFileAfterFailAction: 'Çalıştır',
        cancelUploadNewFileAction: 'İptal',
        itemMenuBtnTitle: 'Daha Fazla',
        dragDropAreaText: 'Yüklemek için dosyaları sürükleyin',
        noDataText: 'Dosya bulunamadı',
        noDataDescription: 'Karşıya yüklemek için dosyaları bırakın veya "Ekle" düğmesini kullanın.',
        paginationTotal: 'Gösterilen: {from}-{to}/{total}',
        resultsPerPage: 'Sayfa başına sonuç',
        messageCreateFailed: '{folderName} klasörü oluşturulamadı.',
        messageCreateSuccess: '{folderName} klasörü oluşturuldu.',
        messageUpdateVersionFailed: '{folderName} klasörünün versiyonu güncellenemedi.',
        messageUpdateVersionSuccess: '{folderName} klasörünün versiyonu güncellendi.',
        messageFileRenameFailed: '"{from}", "{to}" olarak yeniden adlandırılamadı.',
        messageFileRenameSuccess: '"{from}", "{to}" olarak yeniden adlandırıldı.',
        messageRemoveFoldersAndFilesFailed: '{foldersCount} klasör ve {filesCount} dosya kaldırılamadı.',
        messageRemoveFoldersAndFilesSuccess: '{foldersCount} klasör ve {filesCount} dosya kaldırıldı.',
        messageRemoveFoldersFailed: '{foldersCount} klasör kaldırılamadı.',
        messageRemoveFoldersSuccess: '{foldersCount} klasör kaldırıldı.',
        messageRemoveFilesFailed: '{filesCount} dosya kaldırılamadı.',
        messageRemoveFilesSuccess: '{filesCount} dosya kaldırıldı.',
        messageRemoveFileOrFolderFailed: '{name} kaldırılamadı.',
        messageRemoveFileOrFolderSuccess: '{name} kaldırıldı.',
        messageMoveFoldersAndFilesFailed: '{foldersCount} klasör ve {filesCount} dosya {to} konumuna taşınamadı.',
        messageMoveFoldersAndFilesSuccess: '{foldersCount} klasör ve {filesCount} dosya {to} konumuna taşındı.',
        messageMoveFoldersFailed: '{foldersCount} klasör {to} konumuna taşınamadı.',
        messageMoveFoldersSuccess: '{foldersCount} klasör {to} konumuna taşındı.',
        messageMoveFilesFailed: '{filesCount} dosya {to} konumuna taşınamadı.',
        messageMoveFilesSuccess: '{filesCount} dosya {to} konumuna taşındı.',
        messageMoveFileOrFolderFailed: '{name}, {to} konumuna taşınamadı.',
        messageMoveFileOrFolderSuccess: '{name}, {to} konumuna taşındı.',
        messageMoveRootFoldersAndFilesFailed:
            '{foldersCount} klasör ve {filesCount} dosya tüm dosyalar konumuna taşınamadı.',
        messageMoveRootFoldersAndFilesSuccess:
            '{foldersCount} klasör ve {filesCount} dosya tüm dosyalar konumuna taşındı.',
        messageMoveRootFoldersFailed: '{foldersCount} klasör tüm dosyalar konumuna taşınamadı.',
        messageMoveRootFoldersSuccess: '{foldersCount} klasör tüm dosyalar konumuna taşındı.',
        messageMoveRootFilesFailed: '{filesCount} dosya tüm dosyalar konumuna taşınamadı.',
        messageMoveRootFilesSuccess: '{filesCount} dosya tüm dosyalar konumuna taşındı.',
        messageMoveRootFileOrFolderFailed: '{name}, tüm dosyalar konumuna taşınamadı.',
        messageMoveRootFileOrFolderSuccess: '{name}, tüm dosyalar konumuna taşındı.',
        messageFileTypeMismatchPlural: '{filesCount} dosyanın türü yanlış. İzin verilen türler: {allowedTypes}.',
        ...
        messageFileSizeExceededPlural:
            '{filesCount} dosya, azami dosya boyutunu aştı. İzin verilen azami dosya boyutu: {maxFileSize}.',
        messageFileSizeExceededSingular:
            '"{fileName}" dosyası, azami dosya boyutunu aştı. İzin verilen azami dosya boyutu: {maxFileSize}.',
        messageFileNameLengthExceededPlural:
            '{filesCount} dosya, azami dosya adı uzunluğunu aştı. İzin verilen dosya adı uzunluğu: {maxFilenameLength} karakter.',
        messageFileNameLengthExceededSingular:
            '"{fileName}" dosyası, azami dosya adı uzunluğunu aştı. İzin verilen dosya adı uzunluğu: {maxFilenameLength} karakter.'
    },
