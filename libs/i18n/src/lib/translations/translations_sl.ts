...
export default {
    ...
    platformTable: {
        ...
        deselectSingleRowTitle: 'Kliknite za preklic izbire',
        selectSingleRowTitle: 'Kliknite za izbor'
    },
    platformThumbnail: {
        detailsGotoPreviousButtonTitle: 'Pojdi na pretekli',
        detailsGotoNextButtonTitle: 'Pojdi na naslednjega',
        detailsDialogCloseBtnLabel: 'Zapri',
        roleDescription: 'Slika'
    },
    platformUploadCollection: {
        moveToTitle: 'Premakni na',
        moveToTitleFolder: 'Mapa',
        moveToNewFolderBtnLabel: 'Nova mapa',
        moveToAllFilesSubHeaderLabel: 'Vse datoteke',
        moveToConfirmBtn: 'Premakni',
        moveToCloseBtn: 'Prekliči',
        newFolderTitle: 'Nova mapa',
        newFolderAtRootInputLabel: 'Ime nove mape',
        newFolderAtFolderInputLabel: 'Ime nove mape znotraj {folderName}',
        newFolderInputPlaceholder: 'Tipkaj tukaj...',
        newFolderInputErrorLabel: 'Dovoljenih je maksimalno {count} znakov',
        newFolderDialogCreateBtnLabel: 'Ustvari',
        newFolderDialogCancelBtnLabel: 'Prekliči',
        breadcrumbLabelAllFiles: 'Vse datoteke',
        breadcrumbLabelAllFilesWithTotal: 'Vse datoteke ({total})',
        searchPlaceholder: 'Iskanje',
        addBtnLabel: 'Dodaj',
        newFolderBtnLabel: 'Nova mapa',
        moveToBtnLabel: 'Premakni na',
        downloadBtnLabel: 'Prenos iz strežnika',
        updateVersionBtnLabel: 'Posodobi verzijo',
        removeBtnLabel: 'Odstrani',
        folderIconTitle: 'Ikona mape',
        fileIconTitle: 'Ikona datoteke',
        editFileNameInputPlaceholder: 'Vnesi ime',
        editFileNameFileAlreadyExistsError: 'Datoteka s tem imenom že obstaja',
        editFileNameFolderAlreadyExistsError: 'Mapa s tem imenom že obstaja',
        itemStatusSuccessful: 'Uspešno',
        itemStatusUnsuccessful: 'Neuspešno',
        uploadNewFileAfterFailAction: 'Zaženi',
        cancelUploadNewFileAction: 'Prekliči',
        itemMenuBtnTitle: 'Več',
        dragDropAreaText: 'Povleci datoteke za prenos v strežnik',
        noDataText: 'Datoteke niso najdene',
        noDataDescription: 'Spustite datoteke, da jih naložite, ali pa uporabite gumb "Dodaj".',
        paginationTotal: 'Prikaži {from}-{to} od {total}',
        resultsPerPage: 'Rezultati na stran',
        messageCreateFailed: 'Ni uspelo kreirati {folderName}.',
        messageCreateSuccess: '{folderName} je kreirana.',
        messageUpdateVersionFailed: 'Ni uspelo posodobiti verzije {folderName}.',
        messageUpdateVersionSuccess: 'Verzija {folderName} je posodobljena.',
        messageFileRenameFailed: 'Ni uspelo preimenovati "{from}" v "{to}."',
        messageFileRenameSuccess: '"{from}" je bilo preimenovano v "{to}".',
        messageRemoveFoldersAndFilesFailed: 'Ni uspelo odstraniti {foldersCount} map in {filesCount} datotek.',
        messageRemoveFoldersAndFilesSuccess: '{foldersCount} map in {filesCount} datotek je bilo odstranjenih.',
        messageRemoveFoldersFailed: 'Ni uspelo odstraniti {foldersCount} map.',
        messageRemoveFoldersSuccess: '{foldersCount} map je bilo odstranjenih.',
        messageRemoveFilesFailed: 'Ni uspelo odstraniti {foldersCount} map in {filesCount} datotek.',
        messageRemoveFilesSuccess: '{filesCount} datotek je bilo odstranjenih.',
        messageRemoveFileOrFolderFailed: 'Ni uspelo odstraniti {name}.',
        messageRemoveFileOrFolderSuccess: '{name} je bila odstranjena.',
        messageMoveFoldersAndFilesFailed: 'Ni uspelo premakniti {foldersCount} map in {filesCount} datotek v {to}.',
        messageMoveFoldersAndFilesSuccess: '{foldersCount} map in {filesCount} datotek je bilo premaknjenih v {to}.',
        messageMoveFoldersFailed: 'Ni uspelo premakniti {foldersCount} map v {to}.',
        messageMoveFoldersSuccess: '{foldersCount} map je bilo premaknjenih v {to}.',
        messageMoveFilesFailed: 'Ni uspelo premakniti {filesCount} datotek v {to}.',
        messageMoveFilesSuccess: '{filesCount} datotek je bilo premaknjenih v {to}.',
        messageMoveFileOrFolderFailed: 'Ni uspelo premakniti {name} v {to}.',
        messageMoveFileOrFolderSuccess: '{name} je bila premaknjena v {to}.',
        messageMoveRootFoldersAndFilesFailed:
            'Ni uspelo premakniti {foldersCount} map in {filesCount} datotek v vse datoteke.',
        messageMoveRootFoldersAndFilesSuccess:
            '{foldersCount} map in {filesCount} datotek je bilo premaknjenih v vse datoteke.',
        messageMoveRootFoldersFailed: 'Ni uspelo premakniti {foldersCount} map v vse datoteke.',
        messageMoveRootFoldersSuccess: '{foldersCount} map je bilo premaknjenih v vse datoteke.',
        messageMoveRootFilesFailed: 'Ni uspelo premakniti {filesCount} datotek v vse datoteke.',
        messageMoveRootFilesSuccess: '{filesCount} datotek je bilo premaknjenih v vse datoteke.',
        messageMoveRootFileOrFolderFailed: 'Ni uspelo premakniti {name} v vse datoteke.',
        messageMoveRootFileOrFolderSuccess: '{name} je bila premaknjena v vse datoteke.',
        messageFileTypeMismatchPlural: '{filesCount} je napačnega tipa. Dovoljeni tipi: {allowedTypes}.',
        messageFileTypeMismatchSingular: '{filesCount} je napačnega tipa. Dovoljeni tipi: {allowedTypes}.',
        messageFileSizeExceededPlural:
            '{filesCount} datotek presega največjo velikost datotek. Največja dovoljena velikost datoteke: {maxFileSize}.',
        messageFileSizeExceededSingular:
            'Datoteka {fileName} presega največjo velikost datoteke. Največja dovoljena velikost datoteke: {maxFileSize}.',
        messageFileNameLengthExceededPlural:
            '{filesCount} datotek presega največjo dolžino imena datoteke. Dovoljena dolžina imena datoteke: {maxFilenameLength} znakov.',
        messageFileNameLengthExceededSingular:
            'Ime "{fileName}" presega največjo dolžino imena datoteke. Dovoljena dolžina imena datoteke: {maxFilenameLength} znakov.'
    },
