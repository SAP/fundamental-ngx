...
export default {
    ...
    coreMultiInput: {
        ...
        tokensCountText: 'Съдържа {length, plural, =0 {0 токена} =1 {1 токен} other {# токена} }.'
    },
    coreNavigation: {
    ...
    platformTable: {
        ...
        deselectSingleRowTitle: 'Кликнете за отмяна на избора',
        selectSingleRowTitle: 'Кликнете, за да изберете'
    },
    platformThumbnail: {
        detailsGotoPreviousButtonTitle: 'Назад',
        detailsGotoNextButtonTitle: 'Напред',
        detailsDialogCloseBtnLabel: 'Затваряне',
        roleDescription: 'Изображение'
    },
    platformUploadCollection: {
        moveToTitle: 'Преместване в',
        moveToTitleFolder: 'Папка',
        moveToNewFolderBtnLabel: 'Нова папка',
        moveToAllFilesSubHeaderLabel: 'Всички файлове',
        moveToConfirmBtn: 'Преместване',
        moveToCloseBtn: 'Отказ',
        newFolderTitle: 'Нова папка',
        newFolderAtRootInputLabel: 'Име на нова папка',
        newFolderAtFolderInputLabel: 'Име на нова папка в {folderName}',
        newFolderInputPlaceholder: 'Пишете тук...',
        newFolderInputErrorLabel: 'Допускат се максимум {count} символа',
        newFolderDialogCreateBtnLabel: 'Създаване',
        newFolderDialogCancelBtnLabel: 'Отказ',
        ...
        moveToBtnLabel: 'Преместване в',
        downloadBtnLabel: 'Изтегляне',
        updateVersionBtnLabel: 'Актуализиране на версия',
        removeBtnLabel: 'Премахване',
        folderIconTitle: 'Икона за папка',
        fileIconTitle: 'Икона за файл',
        editFileNameInputPlaceholder: 'Въведете име',
        editFileNameFileAlreadyExistsError: 'Вече съществува файл с това име',
        editFileNameFolderAlreadyExistsError: 'Вече съществува папка с това име',
        itemStatusSuccessful: 'Успешно',
        itemStatusUnsuccessful: 'Неуспешно',
        uploadNewFileAfterFailAction: 'Изпълнение',
        cancelUploadNewFileAction: 'Отказ',
        itemMenuBtnTitle: 'Още',
        dragDropAreaText: 'Провлачете файловете, за да ги качите',
        noDataText: 'Не са намерени файлове',
        noDataDescription: 'За да качите файлове, ги пуснете тук или използвайте бутона „Добавяне”.',
        paginationTotal: 'Показване на {from}-{to} от {total}',
        resultsPerPage: 'Резултата на страница',
        messageCreateFailed: 'Неуспешно създаване на {folderName}.',
        messageCreateSuccess: 'Създадена е {folderName}.',
        messageUpdateVersionFailed: 'Неуспешна актуализация на версията на {folderName}.',
        messageUpdateVersionSuccess: 'Версията на {folderName} е актуализирана.',
        messageFileRenameFailed: 'Неуспешно преименуване на "{from}" в "{to}."',
        messageFileRenameSuccess: '"{from}" е преименуван на "{to}".',
        messageRemoveFoldersAndFilesFailed: 'Неуспешо премахване на {foldersCount} папки и {filesCount} файла.',
        messageRemoveFoldersAndFilesSuccess: 'Премахнати са {foldersCount} папки и {filesCount} файла.',
        messageRemoveFoldersFailed: 'Неуспешно премахване на {foldersCount} папки.',
        messageRemoveFoldersSuccess: 'Премахнати са {foldersCount} папки.',
        messageRemoveFilesFailed: 'Неуспешно премахване на {filesCount} файла.',
        messageRemoveFilesSuccess: 'Премахнати са {filesCount} файла.',
        messageRemoveFileOrFolderFailed: 'Неуспешно премахване на {name}.',
        messageRemoveFileOrFolderSuccess: '{name} е премахнато.',
        messageMoveFoldersAndFilesFailed: 'Неуспешно преместване на {foldersCount} папки и {filesCount} файла в {to}.',
        messageMoveFoldersAndFilesSuccess: 'Преместени са {foldersCount} папки и {filesCount} файла в {to}.',
        messageMoveFoldersFailed: 'Неуспешно преместване на {foldersCount} папки в {to}.',
        messageMoveFoldersSuccess: 'Преместени са {foldersCount} папки в {to}.',
        messageMoveFilesFailed: 'Неуспешно преместване на {filesCount} папки в {to}.',
        messageMoveFilesSuccess: 'Преместени са {filesCount} файла в {to}.',
        messageMoveFileOrFolderFailed: 'Неуспешно преместване на {name} в {to}.',
        messageMoveFileOrFolderSuccess: '{name} е преместено в {to}.',
        messageMoveRootFoldersAndFilesFailed:
            'Неуспешно преместване на {foldersCount} папки и {filesCount} файла във всички файлове.',
        messageMoveRootFoldersAndFilesSuccess:
            '{foldersCount} папки и {filesCount} файла са преместени във всички файлове.',
        messageMoveRootFoldersFailed: 'Неуспешно преместване на {foldersCount} папки във всички файлове.',
        messageMoveRootFoldersSuccess: '{foldersCount} папки са преместени във всички файлове.',
        messageMoveRootFilesFailed: 'Неуспешно преместване на {filesCount} файла във всички файлове.',
        messageMoveRootFilesSuccess: '{filesCount} файла са преместени във всички файлове.',
        messageMoveRootFileOrFolderFailed: 'Неуспешно преместване на {name} във всички файлове.',
        messageMoveRootFileOrFolderSuccess: '{name} е преместено във всички файлове.',
        messageFileTypeMismatchPlural: '{filesCount} файла са с неправилен вид. Разрешените видове са: {allowedTypes}.',
        messageFileTypeMismatchSingular:
            'Видът на файла "{fileName}" е неправилен. Разрешените видове са: {allowedTypes}.',
        messageFileSizeExceededPlural:
            '{filesCount} файла превишават максималния размер. Разрешеният максимален размер на файл е: {maxFileSize}',
        messageFileSizeExceededSingular:
            'Файлът "{fileName}" е превишил максималния размер. Разрешеният максимален размер на файл е: {maxFileSize}.',
        messageFileNameLengthExceededPlural:
            '{filesCount} файла са превишили максималната дължина за име на файл. Разрешената максимална дължина за име на файл е: {maxFilenameLength} символа.',
        messageFileNameLengthExceededSingular:
            'Името "{fileName}" надхвърля максималната дължина за име на файл. Разрешената максимална дължина за име на файл е: {maxFilenameLength} символа.'
    },
