...
export default {
    ...
    coreSplitter: {
        paginationItemAriaLabel: 'Secțiune'
    },
    coreStepInput: {
    ...
    platformTable: {
        ...
        P13FilterDialogAddFilterBtnTitle: 'Adăugare filtru',
    ...
    btpSearchField: {
        ...
        searchInputPlaceholder: 'Căutare',
