...
export default {
    ...
    platformTable: {
        ...
        deselectSingleRowTitle: 'Faceți clic pentru a deselecta',
        selectSingleRowTitle: 'Faceți clic pentru a selecta'
    },
    platformThumbnail: {
        detailsGotoPreviousButtonTitle: 'Salt înapoi',
        detailsGotoNextButtonTitle: 'Salt înainte',
        detailsDialogCloseBtnLabel: 'Închidere',
        roleDescription: 'Imagine'
    },
    platformUploadCollection: {
        moveToTitle: 'Mutare în',
        moveToTitleFolder: 'Folder',
        moveToNewFolderBtnLabel: 'Folder nou',
        moveToAllFilesSubHeaderLabel: 'Toate fișierele',
        moveToConfirmBtn: 'Mutare',
        moveToCloseBtn: 'Anulare',
        newFolderTitle: 'Folder nou',
        newFolderAtRootInputLabel: 'Numele folderului nou',
        newFolderAtFolderInputLabel: 'Numele folderului nou în interiorul {folderName}',
        newFolderInputPlaceholder: 'Tastați aici...',
        newFolderInputErrorLabel: 'Sunt permise maximum {count} caractere',
        newFolderDialogCreateBtnLabel: 'Creare',
        newFolderDialogCancelBtnLabel: 'Anulare',
        breadcrumbLabelAllFiles: 'Toate fișierele',
        breadcrumbLabelAllFilesWithTotal: 'Toate fișierele ({total})',
        searchPlaceholder: 'Căutare',
        addBtnLabel: 'Adăugare',
        newFolderBtnLabel: 'Folder nou',
        moveToBtnLabel: 'Mutare în',
        downloadBtnLabel: 'Descărcare',
        updateVersionBtnLabel: 'Actualizare versiune',
        removeBtnLabel: 'Eliminare',
        folderIconTitle: 'Pictograma Folder',
        fileIconTitle: 'Pictograma Fișier',
        editFileNameInputPlaceholder: 'Introduceți un nume',
        editFileNameFileAlreadyExistsError: 'Un fișier cu acest nume există deja',
        editFileNameFolderAlreadyExistsError: 'Folderul cu acest nume există deja',
        itemStatusSuccessful: 'Reușită',
        itemStatusUnsuccessful: 'Eșuată',
        uploadNewFileAfterFailAction: 'Executare',
        cancelUploadNewFileAction: 'Anulare',
        itemMenuBtnTitle: 'Mai mult',
        dragDropAreaText: 'Trageți fișierele pentru a le încărca',
        noDataText: 'Niciun fișier găsit',
        noDataDescription: 'Transferați fișierele cu mouse-ul pentru încărcare sau utilizați butonul „Adăugare”.',
        paginationTotal: 'Se afișează {from}-{to} din {total}',
        resultsPerPage: 'Rezultate pe pagină',
        messageCreateFailed: 'Eroare la creare {folderName}.',
        messageCreateSuccess: '{folderName} a fost creat.',
        messageUpdateVersionFailed: 'Actualizarea versiunii {folderName} a eșuat.',
        messageUpdateVersionSuccess: 'Versiunea {folderName} a fost actualizată.',
        messageFileRenameFailed: 'Eroare la redenumirea din „{from}” în „{to}”.',
        messageFileRenameSuccess: '„{from}” a fost redenumit în „{to}”.',
        messageRemoveFoldersAndFilesFailed: 'Eliminarea a {foldersCount} foldere și {filesCount} fișiere a eșuat.',
        messageRemoveFoldersAndFilesSuccess: '{foldersCount} foldere și {filesCount} fișiere au fost eliminate.',
        messageRemoveFoldersFailed: 'Eliminarea a {foldersCount} foldere a eșuat.',
        messageRemoveFoldersSuccess: '{foldersCount} foldere au fost eliminate.',
        messageRemoveFilesFailed: 'Eliminarea a {filesCount} fișiere a eșuat.',
        messageRemoveFilesSuccess: '{filesCount} fișiere au fost eliminate.',
        messageRemoveFileOrFolderFailed: 'Eliminarea {name} a eșuat.',
        messageRemoveFileOrFolderSuccess: '{name} a fost eliminat.',
        messageMoveFoldersAndFilesFailed: 'Mutarea a {foldersCount} foldere și {filesCount} fișiere în {to} a eșuat.',
        messageMoveFoldersAndFilesSuccess: '{foldersCount} foldere și {filesCount} fișiere au fost mutate în {to}.',
        messageMoveFoldersFailed: 'Mutarea a {foldersCount} foldere în {to} a eșuat.',
        messageMoveFoldersSuccess: '{foldersCount} foldere au fost mutate în {to}.',
        messageMoveFilesFailed: 'Mutarea a {filesCount} fișiere în {to} a eșuat.',
        messageMoveFilesSuccess: '{filesCount} fișiere au fost mutate în {to}.',
        messageMoveFileOrFolderFailed: 'Mutarea {name} în {to} a eșuat.',
        messageMoveFileOrFolderSuccess: '{name} a fost mutat în {to}.',
        messageMoveRootFoldersAndFilesFailed:
            'Mutarea a {foldersCount} foldere și {filesCount} fișiere în toate fișierele a eșuat.',
        messageMoveRootFoldersAndFilesSuccess:
            '{foldersCount} foldere și {filesCount} fișiere au fost mutate în toate fișierele.',
        messageMoveRootFoldersFailed: 'Mutarea a {foldersCount} foldere în toate fișierele a eșuat.',
        messageMoveRootFoldersSuccess: '{foldersCount} foldere au fost mutate în toate fișierele.',
        messageMoveRootFilesFailed: 'Mutarea a {filesCount} fișiere în toate fișierele a eșuat.',
        messageMoveRootFilesSuccess: '{filesCount} fișiere au fost mutate în toate fișierele.',
        messageMoveRootFileOrFolderFailed: 'Mutarea {name} în toate fișierele a eșuat.',
        messageMoveRootFileOrFolderSuccess: '{name} a fost mutat în toate fișierele.',
        messageFileTypeMismatchPlural: '{filesCount} fișiere au tipul incorect. Tipuri permise: {allowedTypes}.',
        messageFileTypeMismatchSingular: 'Fișierul „{fileName}” are tipul incorect. Tipuri permise: {allowedTypes}.',
        messageFileSizeExceededPlural:
            '{filesCount} fișiere depășesc dimensiunea maximă a fișierului. Dimensiunea maximă permisă a fișierului: {maxFileSize}.',
        messageFileSizeExceededSingular:
            'Fișierul „{fileName}” depășește dimensiunea maximă a fișierului. Dimensiunea maximă permisă a fișierului: {maxFileSize}.',
        messageFileNameLengthExceededPlural:
            '{filesCount} fișiere au depășit lungimea maximă a numelui fișierului. Lungimea permisă a numelui fișierului: {maxFilenameLength} caractere.',
        messageFileNameLengthExceededSingular:
            'Numele „{fileName}” a depășit lungimea maximă a numelui fișierului. Lungimea permisă a numelui fișierului: {maxFilenameLength} caractere.'
    },
