...
export default {
    ...
    platformTable: {
        ...
        deselectSingleRowTitle: 'A kijelölés megszüntetéséhez kattintson erre a gombra',
        selectSingleRowTitle: 'A kiválasztáshoz kattintson erre a gombra'
    },
    platformThumbnail: {
        detailsGotoPreviousButtonTitle: 'Vissza az előzőre',
        detailsGotoNextButtonTitle: 'Tovább a következőre',
        detailsDialogCloseBtnLabel: 'Bezárás',
        roleDescription: 'Kép'
    },
    platformUploadCollection: {
        moveToTitle: 'Áthelyezés ide:',
        moveToTitleFolder: 'Mappa',
        moveToNewFolderBtnLabel: 'Új mappa',
        moveToAllFilesSubHeaderLabel: 'Minden fájl',
        moveToConfirmBtn: 'Áthelyezés',
        moveToCloseBtn: 'Mégse',
        newFolderTitle: 'Új mappa',
        newFolderAtRootInputLabel: 'Új mappa neve',
        newFolderAtFolderInputLabel: 'Az új mappa neve ezen belül: {folderName}',
        newFolderInputPlaceholder: 'Ide írjon...',
        newFolderInputErrorLabel: 'Legfeljebb {count} karakterből állhat',
        newFolderDialogCreateBtnLabel: 'Létrehozás',
        newFolderDialogCancelBtnLabel: 'Mégse',
        breadcrumbLabelAllFiles: 'Minden fájl',
        breadcrumbLabelAllFilesWithTotal: 'Minden fájl ({total})',
        searchPlaceholder: 'Keresés',
        addBtnLabel: 'Hozzáadás',
        newFolderBtnLabel: 'Új mappa',
        moveToBtnLabel: 'Áthelyezés ide:',
        downloadBtnLabel: 'Letöltés',
        updateVersionBtnLabel: 'Verziófrissítés',
        removeBtnLabel: 'Eltávolítás',
        folderIconTitle: '„Mappa” ikon',
        fileIconTitle: '„Fájl” ikon',
        editFileNameInputPlaceholder: 'Adja meg a nevet',
        editFileNameFileAlreadyExistsError: 'Már van ilyen nevű fájl',
        editFileNameFolderAlreadyExistsError: 'Már van ilyen nevű mappa',
        itemStatusSuccessful: 'Sikeres',
        itemStatusUnsuccessful: 'Sikertelen',
        uploadNewFileAfterFailAction: 'Futtatás',
        cancelUploadNewFileAction: 'Mégse',
        itemMenuBtnTitle: 'Továbbiak',
        dragDropAreaText: 'Húzza ide a feltöltendő fájlokat',
        noDataText: 'Nem található fájl',
        noDataDescription: 'Húzza ide a feltöltendő fájlokat, vagy kattintson a „Hozzáadás” gombra.',
        paginationTotal: '{from}–{to}. megjelenítése az összesen {total} közül',
        resultsPerPage: 'Találat oldalanként',
        messageCreateFailed: 'Nem sikerült létrehozni a(z) {folderName} mappát.',
        messageCreateSuccess: 'A(z) {folderName} mappa létrehozva.',
        messageUpdateVersionFailed: 'Nem sikerült frissíteni a(z) „{folderName}” mappa verzióját.',
        messageUpdateVersionSuccess: 'A(z) „{folderName}” mappa verziója frissítve.',
        messageFileRenameFailed: 'Nem sikerült átnevezni a(z) „{from}” nevű fájlt erre: „{to}”.',
        messageFileRenameSuccess: 'Átnevezve „{from}” nevűről erre: „{to}”.',
        messageRemoveFoldersAndFilesFailed: 'Nem sikerült eltávolítani {foldersCount} mappát és {filesCount} fájlt.',
        messageRemoveFoldersAndFilesSuccess: '{foldersCount} mappa és {filesCount} fájl eltávolítva.',
        messageRemoveFoldersFailed: 'Nem sikerült eltávolítani {foldersCount} mappát.',
        messageRemoveFoldersSuccess: '{foldersCount} mappa eltávolítva.',
        messageRemoveFilesFailed: 'Nem sikerült eltávolítani {filesCount} fájlt.',
        messageRemoveFilesSuccess: '{filesCount} fájl eltávolítva.',
        messageRemoveFileOrFolderFailed: 'Nem sikerült eltávolítani a következőt: {name}.',
        messageRemoveFileOrFolderSuccess: 'A(z) „{name}” eltávolítva.',
        messageMoveFoldersAndFilesFailed:
            'Nem sikerült áthelyezni {foldersCount} mappát és {filesCount} fájlt ide: {to}.',
        messageMoveFoldersAndFilesSuccess: '{foldersCount} mappa és {filesCount} fájl áthelyezve ide: {to}.',
        messageMoveFoldersFailed: 'Nem sikerült áthelyezni {foldersCount} mappát ide: {to}.',
        messageMoveFoldersSuccess: '{foldersCount} mappa áthelyezve ide: {to}.',
        messageMoveFilesFailed: 'Nem sikerült áthelyezni {filesCount} fájlt ide: {to}.',
        messageMoveFilesSuccess: '{filesCount} fájl áthelyezve ide: {to}.',
        messageMoveFileOrFolderFailed: 'Nem sikerült a(z) „{name}” áthelyezése ide: {to}.',
        messageMoveFileOrFolderSuccess: 'A(z) „{name}” áthelyezve ide: {to}.',
        messageMoveRootFoldersAndFilesFailed:
            'Nem sikerült áthelyezni {foldersCount} mappát és {filesCount} fájlt az összes fájl közé.',
        messageMoveRootFoldersAndFilesSuccess:
            '{foldersCount} mappa és {filesCount} fájl áthelyezve az összes fájl közé.',
        messageMoveRootFoldersFailed: 'Nem sikerült áthelyezni {foldersCount} mappát az összes fájl közé.',
        messageMoveRootFoldersSuccess: '{foldersCount} mappa áthelyezve az összes fájl közé.',
        messageMoveRootFilesFailed: 'Nem sikerült áthelyezni {filesCount} fájlt az összes fájl közé.',
        messageMoveRootFilesSuccess: '{filesCount} fájl áthelyezve az összes fájl közé.',
        messageMoveRootFileOrFolderFailed: 'Nem sikerült a(z) „{name}” áthelyezése az összes fájl közé.',
        messageMoveRootFileOrFolderSuccess: 'A(z) „{name}” áthelyezve az összes fájl közé.',
        messageFileTypeMismatchPlural:
            '{filesCount} fájl helytelen típusú. Ezek az engedélyezett típusok: {allowedTypes}.',
        messageFileTypeMismatchSingular:
            'A(z) „{fileName}” fájl helytelen típusú. Ezek az engedélyezett típusok: {allowedTypes}.',
        messageFileSizeExceededPlural:
            '{filesCount} fájl mérete nagyobb a megengedettnél. A maximális fájlméret: {maxFileSize}.',
        messageFileSizeExceededSingular:
            'A(z) „{fileName}” fájl mérete nagyobb a megengedettnél. A maximális fájlméret: {maxFileSize}.',
        messageFileNameLengthExceededPlural:
            '{filesCount} fájl neve hosszabb a megengedettnél. A fájlnevek legfeljebb {maxFilenameLength} karakterből állhatnak.',
        messageFileNameLengthExceededSingular:
            'A(z) „{fileName}” fájl neve hosszabb a megengedettnél. A fájlnevek legfeljebb {maxFilenameLength} karakterből állhatnak.'
    },
