...
describe('Injection Tokens', () => {
    describe('FD_LANGUAGE', () => {
        it('should be defined as InjectionToken', () => {
            expect(FD_LANGUAGE).toBeDefined();
            expect(FD_LANGUAGE.toString()).toContain('Language for @fundamental-ngx packages');
        });
        ...
        it('should provide default factory with English language', async () => {
            ...
            expect(lang$).toBeInstanceOf(BehaviorSubject);
    ...
    describe('FD_LOCALE', () => {
        it('should be defined as InjectionToken', () => {
            ...
            expect(FD_LOCALE.toString()).toContain('Locale for @fundamental-ngx packages');
        });
        ...
        it('should provide default factory with LOCALE_ID', async () => {
            ...
            expect(locale$).toBeInstanceOf(BehaviorSubject);
