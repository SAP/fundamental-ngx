(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('popper.js'), require('@angular/animations'), require('focus-trap'), require('@angular/forms'), require('@angular/common'), require('rxjs'), require('rxjs/operators'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@fundamental-ngx/core', ['exports', 'popper.js', '@angular/animations', 'focus-trap', '@angular/forms', '@angular/common', 'rxjs', 'rxjs/operators', '@angular/core'], factory) :
    (factory((global['fundamental-ngx'] = global['fundamental-ngx'] || {}, global['fundamental-ngx'].core = {}),global.Popper,global.ng.animations,global.focusTrap,global.ng.forms,global.ng.common,global.rxjs,global.rxjs.operators,global.ng.core));
}(this, (function (exports,Popper,animations,focusTrap,forms,common,rxjs,operators,i0) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var MenuComponent = /** @class */ (function () {
        ...
        MenuComponent.propDecorators = {
            ...
            separator: [{ type: i0.Input }, { type: i0.HostBinding, args: ['class.fd-menu__list--separated',] }]
        };
    ...
    var MenuAddonDirective = /** @class */ (function () {
        ...
        MenuAddonDirective.propDecorators = {
            fdMenuAddonClass: [{ type: i0.HostBinding, args: ['class.fd-menu--addon-before',] }]
        };
    ...
    var MenuItemAddonDirective = /** @class */ (function () {
        ...
        MenuItemAddonDirective.propDecorators = {
            fdMenuItemAddonClass: [{ type: i0.HostBinding, args: ['class.fd-menu__addon-before',] }]
        };
    ...
    var ComboboxComponent = /** @class */ (function () {
        ...
        ComboboxComponent.propDecorators = {
            ...
            communicateByObject: [{ type: i0.Input }],
    ...
    var ModalService = /** @class */ (function () {
        ...
        ModalService.ctorParameters = function () {
            return [
                { type: DynamicComponentService, decorators: [{ type: i0.Inject, args: [DynamicComponentService,] }] }
            ];
        };
        return ModalService;
    }());
    ...
    var SideNavigationLinkDirective = /** @class */ (function (_super) {
        ...
        SideNavigationLinkDirective.propDecorators = {
            ...
            onKeypressHandler: [{ type: i0.HostListener, args: ['keypress', ['$event'],] }],
    ...
    var SelectComponent = /** @class */ (function () {
        ...
        SelectComponent.propDecorators = {
            ...
            resizeScrollHandler: [{ type: i0.HostListener, args: ['window:resize',] }]
        };
    ...
    var MegaMenuSublinkDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        MegaMenuSublinkDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef }
            ];
        };
        MegaMenuSublinkDirective.propDecorators = {
            fdMegaMenuClass: [{ type: i0.HostBinding, args: ['class.fd-mega-menu__sublink',] }]
        };
    ...
    var MegaMenuSubitemDirective = /** @class */ (function () {
        ...
        MegaMenuSubitemDirective.propDecorators = {
            fdMegaMenuClass: [{ type: i0.HostBinding, args: ['class.fd-mega-menu__subitem',] }],
            link: [{ type: i0.ContentChild, args: [MegaMenuSublinkDirective,] }],
    ...
    var MegaMenuLinkDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        MegaMenuLinkDirective.ctorParameters = function () {
            return [
                { type: i0.ElementRef }
            ];
        };
        MegaMenuLinkDirective.propDecorators = {
            fdMegaMenuClass: [{ type: i0.HostBinding, args: ['class.fd-mega-menu__link',] }],
            hasChild: [{ type: i0.Input }, { type: i0.HostBinding, args: ['class.has-child',] }, { type: i0.HostBinding, args: ['attr.aria-haspopup',] }],
            isExpanded: [{ type: i0.Input }, { type: i0.HostBinding, args: ['attr.aria-expanded',] }]
        };
    ...
    var MegaMenuItemComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        MegaMenuItemComponent.ctorParameters = function () {
            return [
                { type: i0.ElementRef },
                { type: MenuKeyboardService },
                { type: i0.ChangeDetectorRef }
        ...
        MegaMenuItemComponent.propDecorators = {
            subItems: [{ type: i0.ContentChildren, args: [MegaMenuSubitemDirective,] }],
            link: [{ type: i0.ContentChild, args: [MegaMenuLinkDirective,] }],
            subList: [{ type: i0.ViewChild, args: ['subList',] }],
            parentElement: [{ type: i0.ViewChild, args: ['parentElement',] }],
            keyDown: [{ type: i0.Output }],
            open: [{ type: i0.Input }],
            subListPosition: [{ type: i0.Input }],
    ...
    var MegaMenuListDirective = /** @class */ (function () {
        ...
        /** @nocollapse */
        MegaMenuListDirective.ctorParameters = function () {
            return [
                { type: MenuKeyboardService }
            ];
        };
        MegaMenuListDirective.propDecorators = {
            fdMegaMenuClass: [{ type: i0.HostBinding, args: ['class.fd-mega-menu__list',] }],
            items: [{ type: i0.ContentChildren, args: [MegaMenuItemComponent,] }]
        };
    ...
    var MegaMenuTitleDirective = /** @class */ (function () {
        ...
        MegaMenuTitleDirective.propDecorators = {
            fdMegaMenuTitleClass: [{ type: i0.HostBinding, args: ['class.fd-mega-menu__title',] }]
        };
    ...
    exports.FundamentalNgxCoreModule = FundamentalNgxCoreModule;
    ...
    exports.DATE_TIME_FORMAT_FACTORY = DATE_TIME_FORMAT_FACTORY;
    exports.DateTimeFormatParser = DateTimeFormatParser;
    exports.DateTimeFormatParserDefault = DateTimeFormatParserDefault;
    ...
    exports.LocalizationEditorItemComponent = LocalizationEditorItemComponent;
    exports.LocalizationEditorMainComponent = LocalizationEditorMainComponent;
    exports.LocalizationEditorInputDirective = LocalizationEditorInputDirective;
    exports.LocalizationEditorTextareaDirective = LocalizationEditorTextareaDirective;
    exports.LocalizationEditorLabel = LocalizationEditorLabel;
    exports.LocalizationEditorElement = LocalizationEditorElement;
    exports.LocalizationEditorLoadLabel = LocalizationEditorLoadLabel;
    exports.MenuModule = MenuModule;
    exports.MenuItemDirective = MenuItemDirective;
    exports.MenuKeyboardService = MenuKeyboardService;
    exports.MenuComponent = MenuComponent;
    exports.DefaultMenuItem = DefaultMenuItem;
    exports.MegaMenuModule = MegaMenuModule;
    exports.MegaMenuItemComponent = MegaMenuItemComponent;
    exports.MegaMenuLinkDirective = MegaMenuLinkDirective;
    exports.MegaMenuSubitemDirective = MegaMenuSubitemDirective;
    exports.MegaMenuSublinkDirective = MegaMenuSublinkDirective;
    ...
    exports.ShellbarActionsComponent = ShellbarActionsComponent;
    exports.ShellbarComponent = ShellbarComponent;
    exports.SideNavigationModule = SideNavigationModule;
    exports.SideNavigationLinkDirective = SideNavigationLinkDirective;
    exports.SideNavigationSublistDirective = SideNavigationSublistDirective;
    ...
    exports.TIME_FORMAT_FACTORY = TIME_FORMAT_FACTORY;
    exports.TimeFormatParser = TimeFormatParser;
    exports.TimeFormatParserDefault = TimeFormatParserDefault;
    ...
    exports.TreeChildComponent = TreeChildComponent;
    ...
    exports.ɵo = BadgeDirective;
    exports.ɵp = LabelDirective;
    exports.ɵq = StatusLabelDirective;
    exports.ɵs = BreadcrumbItemDirective;
    exports.ɵt = BreadcrumbLinkDirective;
    exports.ɵr = BreadcrumbDirective;
    exports.ɵu = ButtonGroupComponent;
    exports.ɵv = ButtonGroupedDirective;
    ...
    exports.ɵbo = DatetimePickerComponent;
    exports.ɵbr = FileDragndropDirective;
    exports.ɵbq = FileSelectDirective;
    exports.ɵbp = FileInputComponent;
    exports.ɵbt = FormControlDirective;
    exports.ɵby = FormGroupComponent;
    exports.ɵbu = FormItemDirective;
    exports.ɵbv = FormLabelDirective;
    exports.ɵbw = FormLegendDirective;
    exports.ɵbx = FormMessageComponent;
    exports.ɵbs = FormSetDirective;
    exports.ɵj = IconComponent;
    exports.ɵbz = IdentifierDirective;
    exports.ɵca = ImageComponent;
    exports.ɵcc = InfiniteScrollDirective;
    exports.ɵcb = InlineHelpComponent;
    exports.ɵce = InputGroupNumberComponent;
    exports.ɵcd = InputGroupSearchComponent;
    exports.ɵcf = InputGroupComponent;
    exports.ɵci = ListActionDirective;
    exports.ɵcj = ListCheckboxComponent;
    exports.ɵch = ListItemDirective;
    exports.ɵcg = ListDirective;
    exports.ɵck = LoadingSpinnerComponent;
    exports.ɵcl = LocalizationEditorComponent;
    exports.ɵco = MegaMenuGroupComponent;
    exports.ɵcn = MegaMenuListDirective;
    exports.ɵcp = MegaMenuTitleDirective;
    exports.ɵcm = MegaMenuComponent;
    exports.ɵbj = MenuAddonDirective;
    exports.ɵbg = MenuGroupComponent;
    exports.ɵbk = MenuItemAddonDirective;
    exports.ɵbi = MenuListDirective;
    exports.ɵbh = MenuTitleDirective;
    exports.ɵct = ModalBodyComponent;
    exports.ɵcu = ModalFooterComponent;
    exports.ɵcs = ModalHeaderComponent;
    exports.ɵcr = modalFadeNgIf;
    exports.ɵcv = ModalBackdrop;
    exports.ɵcw = ModalContainer;
    exports.ɵcy = ModalCloseButtonDirective;
    exports.ɵcx = ModalTitleDirective;
    exports.ɵcq = ModalComponent;
    exports.ɵcz = MultiInputComponent;
    exports.ɵda = PaginationService;
    exports.ɵdg = PanelActionsComponent;
    exports.ɵdi = PanelBodyComponent;
    exports.ɵdf = PanelDescriptionComponent;
    exports.ɵdh = PanelFiltersComponent;
    exports.ɵdj = PanelFooterComponent;
    exports.ɵdk = PanelGridComponent;
    exports.ɵdd = PanelHeadComponent;
    exports.ɵdc = PanelHeaderComponent;
    exports.ɵde = PanelTitleDirective;
    exports.ɵdb = PanelComponent;
    exports.ɵbe = PopoverBodyComponent;
    exports.ɵbd = PopoverControlComponent;
    exports.ɵbf = PopoverContainer;
    exports.ɵbc = PopoverDropdownComponent;
    exports.ɵbb = PopoverComponent;
    exports.ɵdm = ShellbarActionComponent;
    exports.ɵdn = ShellbarLogoComponent;
    exports.ɵdl = ShellbarSubtitleComponent;
    exports.ɵdo = ShellbarTitleComponent;
    exports.ɵdq = SideNavigationGroupComponent;
    exports.ɵdt = SideNavigationItemComponent;
    exports.ɵds = SideNavigationListDirective;
    exports.ɵdu = SideNavigationSubitemDirective;
    exports.ɵdv = SideNavigationSublinkDirective;
    exports.ɵdr = SideNavigationTitleDirective;
    exports.ɵdp = SideNavigationComponent;
    exports.ɵdx = SplitButtonActionTitle;
    exports.ɵdz = SplitButtonLoadActionTitle;
    exports.ɵdy = SplitButtonMenuDirective;
    exports.ɵdw = SplitButtonComponent;
    exports.ɵec = ColumnSortableDirective;
    exports.ɵeb = TableResponsiveWrapperDirective;
    exports.ɵea = TableDirective;
    exports.ɵei = TabItemDirective;
    exports.ɵeh = TabLinkDirective;
    exports.ɵeg = TabNavDirective;
    exports.ɵef = TabLoadTitleDirective;
    exports.ɵee = TabTitleDirective;
    exports.ɵed = TabPanelComponent;
    exports.ɵep = ProductTileContentDirective;
    exports.ɵeo = ProductTileMediaDirective;
    exports.ɵeq = ProductTileTitleDirective;
    exports.ɵen = ProductTileComponent;
    exports.ɵem = TileActionsDirective;
    exports.ɵej = TileContentDirective;
    exports.ɵel = TileMediaDirective;
    exports.ɵek = TileTitleDirective;
    exports.ɵi = AbstractFdNgxClass;
    exports.ɵn = DynamicComponentService;
    exports.ɵbm = DisplayFnPipe;
    exports.ɵbl = PipeModule;
    exports.ɵbn = SearchHighlightPipe;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=fundamental-ngx-core.umd.js.map