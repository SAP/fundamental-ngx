import {
  ...
  export const XL_SCREEN_SIZE = 'xl';
  
  export type ScreenSize = 'sm' | 'md' | 'lg' | 'xl';
  
  export type Layout = 'OneColumnStartFullScreen' | 
  ...
  export class FlexibleColumnLayoutComponent implements AfterViewInit, OnChanges, OnDestroy, OnInit {
    ...
    _handleLeftColumnSeparatorClick(): void {
      switch (this.layout) {
        case TWO_COLUMNS_START_EXPANDED : this._updateCurrentLayout(TWO_COLUMNS_MID_EXPANDED); break;
        case TWO_COLUMNS_MID_EXPANDED : this._updateCurrentLayout(TWO_COLUMNS_START_EXPANDED); break;
        case THREE_COLUMNS_MID_EXPANDED : this._updateCurrentLayout(THREE_COLUMNS_END_MINIMIZED); break;
        case THREE_COLUMNS_END_MINIMIZED : this._updateCurrentLayout(TWO_COLUMNS_START_EXPANDED); break;
        case THREE_COLUMNS_START_MINIMIZED : this._updateCurrentLayout(THREE_COLUMNS_END_MINIMIZED); break;
      }
    }
    ...
    _handleRightColumnSeparatorClick(): void {
      switch (this.layout) {
        case TWO_COLUMNS_END_EXPANDED : this._updateCurrentLayout(THREE_COLUMNS_START_MINIMIZED); break;
        case THREE_COLUMNS_MID_EXPANDED : this._updateCurrentLayout(THREE_COLUMNS_END_EXPANDED); break;
        case THREE_COLUMNS_END_EXPANDED : this._updateCurrentLayout(THREE_COLUMNS_MID_EXPANDED); break;
        case THREE_COLUMNS_END_MINIMIZED : this._updateCurrentLayout(THREE_COLUMNS_MID_EXPANDED); break;
        case THREE_COLUMNS_START_MINIMIZED : this._updateCurrentLayout(TWO_COLUMNS_END_EXPANDED); break;
      }
    }
