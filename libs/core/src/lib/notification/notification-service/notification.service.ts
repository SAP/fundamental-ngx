...
export class NotificationService {
    ...
    public open(
        ...
        const refGroupSub = notificationService.afterClosedGroup.subscribe(
            defaultBehaviourOnGroupClose,
            defaultBehaviourOnGroupClose
        );
    ...
    public createNotificationGroup(
        ...
        return this.dynamicComponentService.createDynamicComponent<NotificationGroupComponent>(
            null,
    ...
    private destroyWholeGroup(notification: ComponentRef<NotificationComponent>): void {
        ...
        if (arrayRef.notificationGroup) {
            ...
            const arrayToDelete = this.notifications.filter(
            ...
            arrayToDelete.forEach((_notification) =>
                this.destroyNotificationComponent(_notification.notificationComponent)
            );
        }
    }
