...
export { CardTitleDirective as CardTitleComponent } from './card-title.directive';
export { CardSubtitleDirective as CardSubtitleComponent } from './card-subtitle.directive';
export { CardSecondSubtitleDirective as CardSecondSubtitleComponent } from './card-second-subtitle.directive';
