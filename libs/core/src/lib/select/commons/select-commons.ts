...
export interface MatSelectCommonBehavior {
    ...
    readonly optionPanelMaxHeight: number;
...
export function mixinMatSelectCommons<T extends Constructor<HasMatCommonBehavior>>(
    ...
    return class extends base {
        ...
        get optionPanelMaxHeight(): number {
        ...
        /** @hidden */
        private _emitSelectChange(defaultVal?: any) {
        ...
        private _calculateOverlayPosition(): void {
            ...
            const panelHeight = Math.min(items * itemHeight, this.optionPanelMaxHeight);
        ...
        private _checkOverlayWithinViewport(maxScroll: number): void {
            ...
            const totalPanelHeight = Math.min(this._getItemCount() * itemHeight, this.optionPanelMaxHeight);
