...
import { AutoCompleteModule, DynamicComponentService, PipeModule, TruncateModule } from '@fundamental-ngx/cdk/utils';
...
import { MultiAnnouncerModule } from './multi-announcer/multi-announcer.directive';
