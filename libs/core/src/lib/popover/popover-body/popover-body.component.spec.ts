...
describe('PopoverBodyComponent', () => {
    ...
    it('should change arrow classes', () => {
        ...
        expect(component._arrowClasses).toEqual([`fd-popover__arrow--${arrowDirection}`, 'fd-popover__arrow-x--start']);
    ...
    it('should change arrow classes 2', () => {
        ...
        expect(component._arrowClasses).toEqual([`fd-popover__arrow--${arrowDirection}`, 'fd-popover__arrow-x--end']);
