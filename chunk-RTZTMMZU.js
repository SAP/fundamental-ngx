import"./chunk-3DNKNTAQ.js";var e=`:host {
    ...
    --_ui5_fcl_decoration_top: light-dark(linear-gradient(to top, var(--sapObjectHeader_BorderColor), #fff), linear-gradient(to top, var(--sapObjectHeader_BorderColor), #000));
    --_ui5_fcl_decoration_bottom: light-dark(linear-gradient(to bottom, var(--sapObjectHeader_BorderColor), #fff), linear-gradient(to bottom, var(--sapObjectHeader_BorderColor), #000));
