export const sections = [
    'fd-textarea-example ',
    'fd-textarea-inline-help-example ',
...
export const styleArr = ['fd-form-message--success', 'fd-form-message--error', 'fd-form-message--warning', 'fd-form-message--information'];
