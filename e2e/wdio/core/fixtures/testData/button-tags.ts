...
const prefix = 'button-core-';
export const typeButtonsExample = prefix + 'type-buttons-example-';
export const menuButtonsExample = prefix + 'menu-buttons-example-';
export const sizeButtonsExample = prefix + 'size-buttons-example-';
export const iconButtonsExample = prefix + 'icon-buttons-example-';
...
export const iconButtonsHoverState = 'icon-buttons-hover-state-' + getImageTagBrowserPlatform();
export const stateButtonHoverState = 'state-button-hover-state-' + getImageTagBrowserPlatform();
export const disableStateButtonsHoverState = 'disable-state-buttons-hover-state-' + getImageTagBrowserPlatform();
export const playgroundButtonHoverState = 'playground-button-hover-state-' + getImageTagBrowserPlatform();
export const inputLabelHoverState = 'input-label-hover-state-' + getImageTagBrowserPlatform();
...
export const iconButtonsActiveState = 'icon-buttons-active-state-' + getImageTagBrowserPlatform();
export const stateButtonActiveState = 'state-button-active-state-' + getImageTagBrowserPlatform();
export const playgroundButtonActiveState = 'playground-button-active-state-' + getImageTagBrowserPlatform();
export const inputLabelActiveState = 'input-label-active-state-' + getImageTagBrowserPlatform();
...
export const iconButtonsFocusState = 'icon-buttons-focus-state-' + getImageTagBrowserPlatform();
export const stateButtonFocusState = 'state-button-focus-state-' + getImageTagBrowserPlatform();
export const playgroundButtonFocusState = 'playground-button-focus-state-' + getImageTagBrowserPlatform();
export const inputLabelFocusState = 'input-label-focus-state-' + getImageTagBrowserPlatform();
