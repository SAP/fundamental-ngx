...
export const activeInputButtonsHoverState = 'active-input-button-hover-state-' + getImageTagBrowserPlatform();
export const activeInputTextAreasFocusState = 'active-input-text-areas-focus-state-' + getImageTagBrowserPlatform();
export const activeInputButtonsFocusState = 'active-input-button-focus-state-' + getImageTagBrowserPlatform();
export const activeInputButtonsActiveState = 'active-input-button-active-state-' + getImageTagBrowserPlatform();
